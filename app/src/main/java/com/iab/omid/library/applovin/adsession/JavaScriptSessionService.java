...
public class JavaScriptSessionService {
    ...
    private void addWebViewListener() {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList("*")), new h.b() { // from class: com.iab.omid.library.applovin.adsession.JavaScriptSessionService.2
            @Override // c1.h.b
            public void onPostMessage(WebView webView, d dVar, Uri uri, boolean z10, c1.a aVar) {
                try {
                    ...
                    com.iab.omid.library.applovin.utils.d.a("Error parsing JS message in JavaScriptSessionService.", e8);
                }
            }
        });
    }
