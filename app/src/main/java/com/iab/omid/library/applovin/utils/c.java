...
public class c {
    ...
    private static WindowManager f15760a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f15761b = {"x", "y", "width", "height"};

    /* renamed from: c  reason: collision with root package name */
    static float f15762c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            if (f15760a != null) {
                ...
                f15760a.getDefaultDisplay().getRealSize(point);
                f11 = a(point.x);
                f10 = a(point.y);
            }
            f10 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f15762c = context.getResources().getDisplayMetrics().density;
            f15760a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0204a c0204a) {
        com.iab.omid.library.applovin.internal.e a10 = c0204a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0204a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f15763a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put("width", a10.f15764a);
            jSONObject.put("height", a10.f15765b);
        } catch (JSONException e8) {
            e8.printStackTrace();
        }
    }
