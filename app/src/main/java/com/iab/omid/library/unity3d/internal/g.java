...
public class g {
    ...
    private static g f16119a = new g();
    ...
    public class a implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ WebView f16120a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ String f16121b;

        a(WebView webView, String str) {
            this.f16120a = webView;
            this.f16121b = str;
        }

        @Override // java.lang.Runnable
        public void run() {
            g.this.c(this.f16120a, this.f16121b);
        }
    }
    ...
    public void a(WebView webView, String str, ErrorType errorType, String str2) {
        a(webView, xn.a.f21422g, errorType.toString(), str2, str);
    }
    ...
    public void a(WebView webView, String str, JSONObject jSONObject) {
        a(webView, b9.a.f16535f, jSONObject, str);
    }
