...
public class c {
    ...
    private static WindowManager f16151a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f16152b = {"x", "y", "width", "height"};

    /* renamed from: c  reason: collision with root package name */
    static float f16153c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            if (f16151a != null) {
                ...
                f16151a.getDefaultDisplay().getRealSize(point);
                f11 = a(point.x);
                f10 = a(point.y);
            }
            f10 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f16153c = context.getResources().getDisplayMetrics().density;
            f16151a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0216a c0216a) {
        com.iab.omid.library.unity3d.internal.e a10 = c0216a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0216a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f16154a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put("width", a10.f16155a);
            jSONObject.put("height", a10.f16156b);
        } catch (JSONException e8) {
            e8.printStackTrace();
        }
    }
