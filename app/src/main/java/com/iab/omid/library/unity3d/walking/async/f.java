...
public class f extends a {
    public f(b.InterfaceC0217b interfaceC0217b, HashSet<String> hashSet, JSONObject jSONObject, long j10) {
        ...
        if (c10 != null) {
            for (com.iab.omid.library.unity3d.adsession.a aVar : c10.b()) {
                if (this.f16183c.contains(aVar.getAdSessionId())) {
                    aVar.getAdSessionStatePublisher().b(str, this.f16185e);
                }
            }
        }
    }
    ...
    public String doInBackground(Object... objArr) {
        if (com.iab.omid.library.unity3d.utils.c.h(this.f16184d, this.f16187b.a())) {
            return null;
        }
        this.f16187b.a(this.f16184d);
