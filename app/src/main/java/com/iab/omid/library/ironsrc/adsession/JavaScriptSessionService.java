...
public class JavaScriptSessionService {
    ...
    private void addWebViewListener() {
        if (!c1.i.a("WEB_MESSAGE_LISTENER")) {
            throw new UnsupportedOperationException("The JavaScriptSessionService cannot be supported in this WebView version.");
        }
        removeWebViewListener();
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList("*")), new h.b() { // from class: com.iab.omid.library.ironsrc.adsession.JavaScriptSessionService.2
            @Override // c1.h.b
            public void onPostMessage(WebView webView, d dVar, Uri uri, boolean z10, c1.a aVar) {
                try {
                    ...
                    if (string.equals(JavaScriptSessionService.JS_MESSAGE_METHOD_START_SESSION)) {
                        ...
                        com.iab.omid.library.ironsrc.utils.d.b("Unexpected method in JavaScriptSessionService: " + string);
                    }
                } catch (JSONException e8) {
                    com.iab.omid.library.ironsrc.utils.d.a("Error parsing JS message in JavaScriptSessionService.", e8);
                }
            }
        });
    }
