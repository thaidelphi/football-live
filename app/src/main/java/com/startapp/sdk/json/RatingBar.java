...
public class RatingBar extends LinearLayout {
    ...
    public static final Map<String, String> f23354a = new HashMap<String, String>() { // from class: com.startapp.sdk.json.RatingBar.1
        {
    ...
    public final void a(String str) {
        try {
            int a10 = j9.a(getContext(), 2);
            int a11 = j9.a(getContext(), 5);
            ...
            if (b10 == null) {
                b10 = c1.a((String) ((HashMap) f23354a).get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(b10, j9.a(getContext(), 15), j9.a(getContext(), 15), true));
