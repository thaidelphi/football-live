...
public final class ru implements du {
    ...
    private WebView f20024b;

    /* renamed from: c  reason: collision with root package name */
    private final WebView f20025c;

    /* renamed from: d  reason: collision with root package name */
    private final JSONObject f20026d;
    ...
    public static final class a extends WebViewClient {
        ...
        public void onPageFinished(WebView webView, String str) {
            ...
            if (!ru.this.f20027e && str != null) {
                r10 = b9.o.r(str, String.valueOf(this.f20031b), false, 2, null);
                if (r10) {
                    ru ruVar = ru.this;
                    b10 = j8.p.b(ruVar.f20026d);
                    kotlin.jvm.internal.n.d(b10, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any?>");
                    ruVar.a(ruVar.a("onDataReady", b10));
                    zt.f21716a.d();
                    ru.this.f20027e = true;
                }
            }
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            ...
            zt.f21716a.a(error.toString());
            lu luVar = lu.f18358a;
            luVar.b("got error during TestSuite web controller loading " + error);
    ...
    public static final class b implements gi {
        ...
        public void onClosed() {
            this.f20033b.onClosed();
        }

        @Override // com.ironsource.gi
        public void onUIReady() {
            if (ru.this.f20028f) {
                this.f20033b.onUIReady();
            } else {
                ru.this.f20023a.postDelayed(new Runnable() { // from class: com.ironsource.y00
    ...
    public ru(TestSuiteActivity activity, gi uiLifeCycleListener, JSONObject jsonData, String str) {
        ...
        this.f20023a = new Handler(activity.getMainLooper());
        this.f20024b = new WebView(activity);
        this.f20025c = new WebView(activity);
        this.f20026d = jsonData;
        this.f20029g = mm.f19249r.d().t();
    ...
    private final void a(TestSuiteActivity testSuiteActivity, final gi giVar, String str) {
        List<? extends IronSource.AD_UNIT> g10;
        WebView webView = this.f20024b;
        WebSettings settings = webView != null ? webView.getSettings() : null;
        boolean z10 = true;
        if (settings != null) {
            settings.setJavaScriptEnabled(true);
        }
        this.f20025c.getSettings().setJavaScriptEnabled(true);
        g10 = j8.q.g(IronSource.AD_UNIT.BANNER, IronSource.AD_UNIT.INTERSTITIAL, IronSource.AD_UNIT.REWARDED_VIDEO);
        if (this.f20029g.a() != null) {
            for (IronSource.AD_UNIT ad_unit : com.ironsource.mediationsdk.p.m().p()) {
                g10.remove(ad_unit);
            }
        } else {
            g10.clear();
        }
        this.f20025c.addJavascriptInterface(new cu(new yt.a().a(g10, testSuiteActivity, this.f20023a), new b(giVar), this), "TestSuiteBridge");
        this.f20025c.setWebViewClient(new a(str));
        if (str != null && str.length() != 0) {
            z10 = false;
        }
        if (!z10) {
            this.f20025c.loadUrl(str);
        }
        WebView webView2 = this.f20024b;
        if (webView2 != null) {
        ...
        this.f20023a.postDelayed(new Runnable() { // from class: com.ironsource.w00
            @Override // java.lang.Runnable
            public final void run() {
                ru.e(ru.this);
            }
        }, 2000L);
        this.f20023a.postDelayed(new Runnable() { // from class: com.ironsource.v00
            @Override // java.lang.Runnable
            public final void run() {
                ru.a(gi.this);
            }
    ...
    public static final void a(ru this$0, String script) {
        ...
        WebView webView = this$0.f20025c;
    ...
    public final String a(String methodName, List<? extends Object> methodArgs) {
        ...
        String b10 = qu.f19902a.b(methodArgs);
        if (!(b10.length() > 0)) {
            return str + "()";
        }
        return str + '(' + b10 + ')';
    ...
    public final void a() {
        b();
        this.f20025c.destroy();
    }

    public final void a(final String script) {
        kotlin.jvm.internal.n.f(script, "script");
        this.f20023a.post(new Runnable() { // from class: com.ironsource.x00
            @Override // java.lang.Runnable
            public final void run() {
                ru.a(ru.this, script);
            }
    ...
    public void a(String callbackName, IronSource.AD_UNIT adUnit, List<? extends Object> args) {
        ...
        if (this.f20027e) {
            ...
            kotlin.jvm.internal.n.e(ad_unit, "adUnit.toString()");
            f10 = j8.q.f(callbackName, ad_unit, args);
            a(a("onCallbackReceived", f10));
        }
    }
