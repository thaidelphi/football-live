...
public class c extends SettingsManager {
    ...
    private static c f10038u;

    /* renamed from: v  reason: collision with root package name */
    private String f10039v = "https://cdn.appnext.com/tools/sdk/confign/fullscreen/" + com.appnext.core.i.Y() + "/fullscreen_config.txt";

    /* renamed from: w  reason: collision with root package name */
    private HashMap<String, String> f10040w = null;
    ...
    protected final HashMap<String, String> l() {
        ...
        hashMap.put("show_close", com.ironsource.mediationsdk.metadata.a.f18924g);
