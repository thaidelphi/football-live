...
public class c {
    ...
    private static final ThreadLocal<Matrix> f14413a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<RectF> f14414b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f14413a;
        ...
        ThreadLocal<RectF> threadLocal2 = f14414b;
