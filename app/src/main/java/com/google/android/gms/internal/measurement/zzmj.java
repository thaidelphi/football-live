...
public class zzmj extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i10 <= size) {
            int i11 = (i10 + size) / 2;
            int compareTo2 = comparable.compareTo(((zzmd) this.zzb.get(i11)).zza());
            if (compareTo2 < 0) {
                size = i11 - 1;
    ...
    public final Object zzl(int i10) {
        zzn();
        Object value = ((zzmd) this.zzb.remove(i10)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (zzb == zzmjVar.zzb()) {
            for (int i10 = 0; i10 < zzb; i10++) {
                if (!zzg(i10).equals(zzmjVar.zzg(i10))) {
                    return false;
                }
            }
            if (zzb != size) {
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < zzb; i11++) {
            i10 += ((zzmd) this.zzb.get(i11)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i11 = this.zza;
        if (size == i11) {
            zzmd zzmdVar = (zzmd) this.zzb.remove(i11 - 1);
            zzm().put(zzmdVar.zza(), zzmdVar.getValue());
        }
        this.zzb.add(i10, new zzmd(this, comparable, obj));
        return null;
    }
