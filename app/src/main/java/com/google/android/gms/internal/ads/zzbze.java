...
final class zzbze extends zzbzf implements ViewTreeObserver.OnScrollChangedListener {
    private final WeakReference zza;

    public zzbze(View view, ViewTreeObserver.OnScrollChangedListener onScrollChangedListener) {
        super(view);
