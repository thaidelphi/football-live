...
public final class zzgqb extends zzgwk implements zzgxw {
    ...
    static {
        ...
        zza = zzgqbVar;
        zzgwk.zzbZ(zzgqb.class, zzgqbVar);
    }
    ...
    public static zzgqb zzd(zzgvc zzgvcVar, zzgvu zzgvuVar) throws zzgwz {
        return (zzgqb) zzgwk.zzbr(zza, zzgvcVar, zzgvuVar);
    }
