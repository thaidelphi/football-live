...
public class zzfut extends AbstractCollection {
    final Collection zza;
    final zzfsw zzb;

    /* JADX INFO: Access modifiers changed from: package-private */
    public zzfut(Collection collection, zzfsw zzfswVar) {
        this.zza = collection;
        this.zzb = zzfswVar;
    }
    ...
    public final void clear() {
        zzfwb.zzb(this.zza, this.zzb);
    }

    @Override // java.util.AbstractCollection, java.util.Collection
    public final boolean contains(Object obj) {
        if (zzfuu.zza(this.zza, obj)) {
