...
public final class b extends r3 {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public b(zzkz zzkzVar) {
        super(zzkzVar);
    }

    private final h4 i(Integer num) {
        if (this.f12872f.containsKey(num)) {
            return (h4) this.f12872f.get(num);
        }
        h4 h4Var = new h4(this, this.f12870d, null);
        this.f12872f.put(num, h4Var);
        return h4Var;
    }

    private final boolean j(int i10, int i11) {
        h4 h4Var = (h4) this.f12872f.get(Integer.valueOf(i10));
        if (h4Var == null) {
            return false;
        }
        return h4.b(h4Var).get(i11);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:393:0x0a59, code lost:
        r0 = r64.f13220a.zzay().r();
        r6 = com.google.android.gms.measurement.internal.zzeo.u(r64.f12870d);
     */
    ...
    */
    public final java.util.List h(java.lang.String r65, java.util.List r66, java.util.List r67, java.lang.Long r68, java.lang.Long r69) {
        /*
            Method dump skipped, instructions count: 2894
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.b.h(java.lang.String, java.util.List, java.util.List, java.lang.Long, java.lang.Long):java.util.List");
    }
}
