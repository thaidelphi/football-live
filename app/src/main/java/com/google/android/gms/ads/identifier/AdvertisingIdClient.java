...
public class AdvertisingIdClient {
    ...
    public static boolean getIsAdIdFakeForDebugLogging(Context context) throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        try {
            ...
            synchronized (advertisingIdClient) {
                ...
                Preconditions.m(advertisingIdClient.zza);
                Preconditions.m(advertisingIdClient.zzb);
                try {
    ...
    private final Info zzd(int i10) throws IOException {
        ...
        synchronized (this) {
            ...
            Preconditions.m(this.zza);
            Preconditions.m(this.zzb);
            try {
    ...
    public final void zza() {
        ...
        synchronized (this) {
            ...
            if (this.zzc) {
                ConnectionTracker.b().c(this.zzg, this.zza);
            }
            this.zzc = false;
            this.zzb = null;
            this.zza = null;
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (ConnectionTracker.b().a(context, intent, blockingServiceConnection, 1)) {
                    ...
                    try {
                        this.zzb = zze.zza(blockingServiceConnection.a(10000L, TimeUnit.MILLISECONDS));
                        this.zzc = true;
                        if (z10) {
                            zze();
                        }
    ...
    final boolean zzc(Info info, boolean z10, float f10, long j10, String str, Throwable th) {
        if (Math.random() <= 0.0d) {
            ...
            if (th != null) {
                hashMap.put(xn.a.f21422g, th.getClass().getName());
            }
