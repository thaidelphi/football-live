...
public final class zzyh implements zzyd, zzgr {
    public static final zzfvv zza = zzfvv.zzr(4300000L, 3200000L, 2400000L, 1700000L, 860000L);
    public static final zzfvv zzb = zzfvv.zzr(1500000L, 980000L, 750000L, 520000L, 290000L);
    public static final zzfvv zzc = zzfvv.zzr(2000000L, 1300000L, 1000000L, 860000L, 610000L);
    public static final zzfvv zzd = zzfvv.zzr(2500000L, 1700000L, 1200000L, 970000L, 680000L);
    public static final zzfvv zze = zzfvv.zzr(4700000L, 2800000L, 2100000L, 1700000L, 980000L);
    public static final zzfvv zzf = zzfvv.zzr(2700000L, 2000000L, 1600000L, 1300000L, 1000000L);
    private static zzyh zzg;
    private final zzfvy zzh;
    private final zzyb zzi = new zzyb();
    private final zzyx zzj = new zzyx(2000);
    private int zzk;
    private long zzl;
    private long zzm;
    private long zzn;
    ...
    /* synthetic */ zzyh(Context context, Map map, int i10, zzcw zzcwVar, boolean z10, zzyg zzygVar) {
        this.zzh = zzfvy.zzc(map);
        if (context != null) {
            zzdv zzb2 = zzdv.zzb(context);
            int zza2 = zzb2.zza();
            this.zzr = zza2;
            this.zzp = zzj(zza2);
            zzb2.zzd(new zzyf(this));
            return;
        }
        this.zzr = 0;
        this.zzp = zzj(0);
    ...
    public static synchronized zzyh zzh(Context context) {
        zzyh zzyhVar;
        String zzb2;
            ...
            if (zzg == null) {
                ...
                if (context != null && (telephonyManager = (TelephonyManager) context.getSystemService("phone")) != null) {
                    ...
                    if (!TextUtils.isEmpty(networkCountryIso)) {
                        zzb2 = zzfsb.zzb(networkCountryIso);
                        int[] zzn = zzn(zzb2);
                        HashMap hashMap = new HashMap(8);
                        hashMap.put(0, 1000000L);
                        zzfvv zzfvvVar = zza;
                        hashMap.put(2, (Long) zzfvvVar.get(zzn[0]));
                        ...
                        hashMap.put(7, (Long) zzfvvVar.get(zzn[0]));
                        zzg = new zzyh(applicationContext, hashMap, 2000, zzcw.zza, true, null);
                    }
                }
                zzb2 = zzfsb.zzb(Locale.getDefault().getCountry());
                int[] zzn2 = zzn(zzb2);
                HashMap hashMap2 = new HashMap(8);
                hashMap2.put(0, 1000000L);
                zzfvv zzfvvVar2 = zza;
                hashMap2.put(2, (Long) zzfvvVar2.get(zzn2[0]));
                ...
                hashMap2.put(7, (Long) zzfvvVar2.get(zzn2[0]));
                zzg = new zzyh(applicationContext, hashMap2, 2000, zzcw.zza, true, null);
            }
            zzyhVar = zzg;
        }
        return zzyhVar;
    ...
    private static boolean zzm(zzfw zzfwVar, boolean z10) {
        return z10 && !zzfwVar.zzb(8);
    }
    ...
    */
    private static int[] zzn(java.lang.String r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzyh.zzn(java.lang.String):int[]");
    }
    ...
    @Override // com.google.android.gms.internal.ads.zzyd
    public final void zzf(Handler handler, zzyc zzycVar) {
        Objects.requireNonNull(zzycVar);
        this.zzi.zza(handler, zzycVar);
    }

    @Override // com.google.android.gms.internal.ads.zzyd
    public final void zzg(zzyc zzycVar) {
        this.zzi.zzc(zzycVar);
    }
}
