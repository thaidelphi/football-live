...
public final class zzfyo {
    ...
    public static int zza(double d10, RoundingMode roundingMode) {
        boolean zzd;
        zzfsv.zzf(d10 > 0.0d && zzfyp.zzb(d10), "x must be positive and finite");
        int exponent = Math.getExponent(d10);
        if (Math.getExponent(d10) >= -1022) {
            switch (zzfyn.zza[roundingMode.ordinal()]) {
                case 1:
                    zzfyu.zzb(zzd(d10));
                    return exponent;
                case 2:
                ...
                case 7:
                case 8:
                    double longBitsToDouble = Double.longBitsToDouble((Double.doubleToRawLongBits(d10) & 4503599627370495L) | 4607182418800017408L);
    ...
    */
    public static long zzb(double r8, java.math.RoundingMode r10) {
        /*
            boolean r0 = com.google.android.gms.internal.ads.zzfyp.zzb(r8)
            if (r0 == 0) goto Lbb
            int[] r0 = com.google.android.gms.internal.ads.zzfyn.zza
            int r1 = r10.ordinal()
            r0 = r0[r1]
            r1 = 1
        ...
        L76:
            boolean r0 = zzc(r8)
            com.google.android.gms.internal.ads.zzfyu.zzb(r0)
        L7d:
            r4 = r8
        L7e:
        ...
        Lbb:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzfyo.zzb(double, java.math.RoundingMode):long");
    }

    public static boolean zzc(double d10) {
        return zzfyp.zzb(d10) && (d10 == 0.0d || 52 - Long.numberOfTrailingZeros(zzfyp.zza(d10)) <= Math.getExponent(d10));
    }

    public static boolean zzd(double d10) {
        if (d10 > 0.0d && zzfyp.zzb(d10)) {
            long zza2 = zzfyp.zza(d10);
            if ((zza2 & ((-1) + zza2)) == 0) {
                return true;
            }
        }
