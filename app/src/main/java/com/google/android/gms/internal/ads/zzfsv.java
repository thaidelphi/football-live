...
public final class zzfsv {
    public static int zza(int i10, int i11, String str) {
        ...
        if (i10 < 0 || i10 >= i11) {
            if (i10 < 0) {
                zzb = zzftm.zzb("%s (%s) must not be negative", "index", Integer.valueOf(i10));
            } else if (i11 < 0) {
                throw new IllegalArgumentException("negative size: " + i11);
            } else {
                zzb = zzftm.zzb("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i10), Integer.valueOf(i11));
            }
    ...
    public static void zzg(boolean z10, String str, char c10) {
        if (!z10) {
            throw new IllegalArgumentException(zzftm.zzb(str, Character.valueOf(c10)));
        }
    }

    public static void zzh(boolean z10, String str, long j10) {
        if (!z10) {
            throw new IllegalArgumentException(zzftm.zzb(str, Long.valueOf(j10)));
        }
    }
    ...
    public static void zzj(boolean z10, String str, int i10, int i11) {
        if (!z10) {
            throw new IllegalArgumentException(zzftm.zzb(str, Integer.valueOf(i10), Integer.valueOf(i11)));
        }
    }
    ...
    public static void zzk(int i10, int i11, int i12) {
        ...
        if (i10 < 0 || i11 < i10 || i11 > i12) {
            if (i10 >= 0 && i10 <= i12) {
                zzn = (i11 < 0 || i11 > i12) ? zzn(i11, i12, "end index") : zzftm.zzb("end index (%s) must not be less than start index (%s)", Integer.valueOf(i11), Integer.valueOf(i10));
            } else {
    ...
    private static String zzn(int i10, int i11, String str) {
        if (i10 < 0) {
            return zzftm.zzb("%s (%s) must not be negative", str, Integer.valueOf(i10));
        }
        if (i11 >= 0) {
            return zzftm.zzb("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i10), Integer.valueOf(i11));
        }
        throw new IllegalArgumentException("negative size: " + i11);
    }
}
