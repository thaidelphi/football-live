...
public final class zzayr extends zzaym {
        ...
        if (length == 1) {
            ...
            if (length < 5) {
                ...
                for (int i11 = 0; i11 < split.length; i11++) {
                    int zza2 = zzayq.zza(split[i11]);
                    int i12 = (zza2 >> 16) ^ ((char) zza2);
                    byte b10 = (byte) (i12 >> 8);
                    int i13 = i11 + i11;
                    bArr[i13] = new byte[]{(byte) i12, b10}[0];
                    bArr[i13 + 1] = b10;
                }
            } else {
                bArr = new byte[length];
                for (int i14 = 0; i14 < split.length; i14++) {
                    int zza3 = zzayq.zza(split[i14]);
