...
public final class zzdc implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdc(Handler handler, zzdb zzdbVar) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i10) throws zzdd {
        EGLSurface eglCreatePbufferSurface;
        EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
        zzde.zza(eglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        zzde.zza(EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        ...
        int i11 = zzeh.zza;
        zzde.zza(z10, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", objArr));
        ...
        zzde.zza(eglCreateContext != null, "eglCreateContext failed");
        ...
        if (i10 == 1) {
            ...
            zzde.zza(eglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
        }
        zzde.zza(EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext), "eglMakeCurrent failed");
