...
interface zzgyi {
    ...
    @Deprecated
    void zzC(List list, zzgyo zzgyoVar, zzgvu zzgvuVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgyo zzgyoVar, zzgvu zzgvuVar) throws IOException;
    ...
    zzgvc zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzgyo zzgyoVar, zzgvu zzgvuVar) throws IOException;

    void zzu(Object obj, zzgyo zzgyoVar, zzgvu zzgvuVar) throws IOException;
