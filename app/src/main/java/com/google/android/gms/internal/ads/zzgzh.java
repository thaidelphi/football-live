...
public final class zzgzh {
    ...
    private static final zzgzg zzf;
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzgzh.<clinit>():void");
    }
    ...
    public static void zzG(Object obj, long j10, byte b10) {
        zzgzg zzgzgVar = zzf;
        long j11 = (-4) & j10;
        int i10 = zzgzgVar.zza.getInt(obj, j11);
        int i11 = ((~((int) j10)) & 3) << 3;
        zzgzgVar.zza.putInt(obj, j11, ((255 & b10) << i11) | (i10 & (~(255 << i11))));
    }
    ...
    public static void zzH(Object obj, long j10, byte b10) {
        ...
        long j11 = (-4) & j10;
        int i10 = (((int) j10) & 3) << 3;
        zzgzgVar.zza.putInt(obj, j11, ((255 & b10) << i10) | (zzgzgVar.zza.getInt(obj, j11) & (~(255 << i10))));
    }
    ...
    public static long zze(ByteBuffer byteBuffer) {
        zzgzg zzgzgVar = zzf;
        return zzgzgVar.zza.getLong(byteBuffer, zzi);
    }
    ...
    public static Unsafe zzi() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzgzd());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    static /* bridge */ /* synthetic */ void zzj(Throwable th) {
        Logger.getLogger(zzgzh.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
