...
public final class zzno implements zznn {
    ...
    static {
        ...
        zzr = zza2.zzd("measurement.service_client.idle_disconnect_millis", ServiceProvider.SCAR_VERSION_FETCH_TIMEOUT);
        ...
        zzF = zza2.zzd("measurement.upload.max_public_events_per_day", ServiceProvider.SCAR_SIGNALS_FETCH_TIMEOUT);
