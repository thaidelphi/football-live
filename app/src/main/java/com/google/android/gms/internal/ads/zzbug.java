...
public final class zzbug {
    ...
    */
    public zzbug(android.content.Context r7) {
        /*
            r6 = this;
            r6.<init>()
        ...
        L63:
            ...
            goto L61
        L68:
            com.google.android.gms.common.wrappers.PackageManagerWrapper r3 = com.google.android.gms.common.wrappers.Wrappers.a(r7)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L61
        ...
        L8a:
            r6.zzx = r0
            com.google.android.gms.common.wrappers.PackageManagerWrapper r0 = com.google.android.gms.common.wrappers.Wrappers.a(r7)     // Catch: java.lang.Exception -> Lb0
        ...
        Lcb:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbug.<init>(android.content.Context):void");
    }
    ...
    */
    private final void zze(android.content.Context r6) {
        /*
            ...
            r5.zzg = r2
            boolean r2 = com.google.android.gms.common.util.PlatformVersion.l()
            r3 = 0
            if (r2 == 0) goto L31
            com.google.android.gms.internal.ads.zzbbd r2 = com.google.android.gms.internal.ads.zzbbm.zziB
        ...
        L6f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbug.zze(android.content.Context):void");
    }

    public final zzbuh zza() {
        return new zzbuh(this.zza, this.zzq, this.zzr, this.zzg, this.zzs, this.zzt, this.zzu, this.zzv, this.zzb, this.zzc, this.zzw, this.zzx, this.zzB, this.zzd, this.zzh, this.zzi, this.zzj, this.zze, this.zzf, this.zzy, this.zzz, this.zzA, this.zzm, this.zzn, this.zzk, this.zzl, this.zzo, this.zzC, this.zzp);
    }

    public zzbug(Context context, zzbuh zzbuhVar) {
        zzbbm.zza(context);
        zzc(context);
        zze(context);
        zzd(context);
        ...
        this.zzq = zzbuhVar.zza;
        this.zzr = zzbuhVar.zzb;
        this.zzs = zzbuhVar.zzc;
        this.zzt = zzbuhVar.zzd;
        this.zzu = zzbuhVar.zze;
        this.zzv = zzbuhVar.zzf;
        this.zzw = zzbuhVar.zzg;
        this.zzx = zzbuhVar.zzh;
        this.zzB = zzbuhVar.zzi;
        this.zzy = zzbuhVar.zzl;
        this.zzz = zzbuhVar.zzm;
        this.zzA = zzbuhVar.zzn;
    }
}
