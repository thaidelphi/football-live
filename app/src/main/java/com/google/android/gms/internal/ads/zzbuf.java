...
public final class zzbuf {
    ...
    public zzbuf(JSONObject jSONObject) {
        ...
        this.zze = zzm(jSONObject.optString("cookies_include", com.ironsource.mediationsdk.metadata.a.f18924g));
    ...
    private static boolean zzm(String str) {
        return str != null && (str.equals("1") || str.equals(com.ironsource.mediationsdk.metadata.a.f18924g));
    }
