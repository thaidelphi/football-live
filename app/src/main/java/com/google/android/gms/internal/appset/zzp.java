...
public final class zzp extends GoogleApi<Api.ApiOptions.NoOptions> implements AppSetIdClient {
    ...
    public zzp(Context context, GoogleApiAvailabilityLight googleApiAvailabilityLight) {
        super(context, zzc, Api.ApiOptions.f12045r0, GoogleApi.Settings.f12053c);
        this.zzd = context;
    ...
    public final Task<AppSetIdInfo> getAppSetIdInfo() {
        if (this.zze.j(this.zzd, 212800000) == 0) {
            return doRead(TaskApiCall.a().d(com.google.android.gms.appset.zze.zza).b(new RemoteCall() { // from class: com.google.android.gms.internal.appset.zzm
