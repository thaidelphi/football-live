...
public final class zzee {
    ...
    protected zzee(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        try {
            if (com.google.android.gms.measurement.internal.zzij.b(context, "google_app_id", com.google.android.gms.measurement.internal.zzfq.a(context)) != null && !zzR()) {
                this.zzi = null;
                this.zzh = true;
    ...
    public final void zzB(com.google.android.gms.measurement.internal.zzgz zzgzVar) {
        ...
        synchronized (this.zzf) {
            for (int i10 = 0; i10 < this.zzf.size(); i10++) {
                if (zzgzVar.equals(((Pair) this.zzf.get(i10)).first)) {
        ...
        synchronized (this.zzf) {
            ...
            while (true) {
                if (i10 >= this.zzf.size()) {
                    pair = null;
                    break;
                } else if (zzgzVar.equals(((Pair) this.zzf.get(i10)).first)) {
    ...
    public final Bundle zzc(Bundle bundle, boolean z10) {
        ...
        if (z10) {
            return zzbzVar.zzb(ServiceProvider.SCAR_VERSION_FETCH_TIMEOUT);
        }
        return null;
    }
    ...
    public final zzcc zzf(Context context, boolean z10) {
        try {
            return zzcb.asInterface(DynamiteModule.e(context, DynamiteModule.f12798e, ModuleDescriptor.MODULE_ID).d("com.google.android.gms.measurement.internal.AppMeasurementDynamiteService"));
    ...
    public final List zzp(String str, String str2) {
        ...
        List list = (List) zzbz.zze(zzbzVar.zzb(ServiceProvider.SCAR_VERSION_FETCH_TIMEOUT), List.class);
    ...
    public final Map zzq(String str, String str2, boolean z10) {
        ...
        Bundle zzb = zzbzVar.zzb(ServiceProvider.SCAR_VERSION_FETCH_TIMEOUT);
