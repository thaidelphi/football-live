...
public final class zzanv {
    public static X509Certificate[][] zza(String str) throws zzanr, SecurityException, IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, AndroidDynamicDeviceInfoDataSource.DIRECTORY_MODE_READ);
        try {
            Pair zzc = zzanw.zzc(randomAccessFile);
            if (zzc != null) {
                ...
                if (j10 >= 0) {
                    ...
                    if (randomAccessFile.readInt() == 1347094023) {
                        throw new zzanr("ZIP64 APK not supported");
                    }
                }
                long zza = zzanw.zza(byteBuffer);
                if (zza < longValue) {
                    if (zzanw.zzb(byteBuffer) + zza == longValue) {
                        if (zza >= 32) {
                            ...
                            if (allocate.getLong(8) == 2334950737559900225L && allocate.getLong(16) == 3617552046287187010L) {
                                ...
                                if (j11 < allocate.capacity() || j11 > 2147483639) {
                                    throw new zzanr("APK Signing Block size out of range: " + j11);
                                }
                                int i11 = (int) (8 + j11);
                                long j12 = zza - i11;
                                if (j12 >= 0) {
                                                            ...
                                                            if (j14 >= 4 && j14 <= 2147483647L) {
                                                                ...
                                                                if (i12 <= slice.remaining()) {
                                                                    if (slice.getInt() == 1896449818) {
                                                                        X509Certificate[][] zzl = zzl(randomAccessFile.getChannel(), new zzanq(zze(slice, i12 - 4), longValue2, zza, longValue, byteBuffer, null));
                                                                        randomAccessFile.close();
                                                                        return zzl;
                                                                    }
                                                                    slice.position(position2);
                                                                } else {
                                                                    throw new zzanr("APK Signing Block entry #" + i10 + " size out of range: " + i12 + ", available: " + slice.remaining());
                                                                }
                                                            } else {
                                                                throw new zzanr("APK Signing Block entry #" + i10 + " size out of range: " + j14);
                                                            }
                                                        } else {
                                                            throw new zzanr("Insufficient data to read size of APK Signing Block entry #" + i10);
                                                        }
                                                    }
                                                    throw new zzanr("No APK Signature Scheme v2 block in APK Signing Block");
                                                }
                                    ...
                                    throw new zzanr("APK Signing Block sizes in header and footer do not match: " + j13 + " vs " + j11);
                                }
                                throw new zzanr("APK Signing Block offset out of range: " + j12);
                            }
                            throw new zzanr("No APK Signing Block before ZIP Central Directory");
                        }
                        throw new zzanr("APK too small for APK Signing Block. ZIP Central Directory offset: " + zza);
                    }
                    throw new zzanr("ZIP Central Directory is not immediately followed by End of Central Directory");
                }
                throw new zzanr("ZIP Central Directory offset out of range: " + zza + ". ZIP End of Central Directory offset: " + longValue);
            }
            throw new zzanr("Not an APK file: ZIP End of Central Directory record not found in file with " + randomAccessFile.length() + " bytes");
        } finally {
            try {
                randomAccessFile.close();
    ...
    private static void zzh(Map map, FileChannel fileChannel, long j10, long j11, long j12, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            zzanp zzanpVar = new zzanp(fileChannel, 0L, j10);
            zzanp zzanpVar2 = new zzanp(fileChannel, j11, j12 - j11);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            zzanw.zzd(duplicate, j10);
            zzann zzannVar = new zzann(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] zzk = zzk(iArr, new zzano[]{zzanpVar, zzanpVar2, zzannVar});
    ...
    */
    private static java.security.cert.X509Certificate[] zzj(java.nio.ByteBuffer r22, java.util.Map r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzanv.zzj(java.nio.ByteBuffer, java.util.Map, java.security.cert.CertificateFactory):java.security.cert.X509Certificate[]");
    }

    private static byte[][] zzk(int[] iArr, zzano[] zzanoVarArr) throws DigestException {
        long j10;
        int i10;
        int length;
        long j11 = 0;
        ...
        while (true) {
            ...
            j12 += (zzanoVarArr[i12].zza() + 1048575) / 1048576;
            i12++;
        }
        if (j12 < 2097151) {
            ...
            for (i10 = 3; i16 < i10; i10 = 3) {
                zzano zzanoVar = zzanoVarArr[i16];
                long j13 = j11;
                long zza = zzanoVar.zza();
                while (zza > j11) {
                    ...
                    long j14 = j13;
                    try {
                        zzanoVar.zzb(messageDigestArr, j14, min);
                        byte[] bArr4 = bArr3;
                        int i19 = 0;
                        while (i19 < iArr.length) {
                            int i20 = iArr[i19];
                            zzano zzanoVar2 = zzanoVar;
                            byte[] bArr5 = bArr[i19];
                            int zzb = zzb(i20);
                            int i21 = length;
    ...
    private static X509Certificate[][] zzl(FileChannel fileChannel, zzanq zzanqVar) throws SecurityException {
            ...
            try {
                ...
                while (zzf.hasRemaining()) {
                    ...
                    try {
                        ...
                        throw new SecurityException("Failed to parse/verify signer #" + i10 + " block", e8);
                    }
                }
                if (i10 > 0) {
                    if (!hashMap.isEmpty()) {
