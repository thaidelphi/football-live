...
public final class zzauc {
    ...
    private final Uri zzg(Uri uri, String str) throws zzaud {
        ...
        try {
                ...
                if (uri.getHost().equals(this.zzb)) {
                    if (uri.getPath().contains(";")) {
                        if (!uri.toString().contains("dc_ms=")) {
                            ...
                            if (indexOf != -1) {
                                int i10 = indexOf + 1;
                                return Uri.parse(uri2.substring(0, i10) + "dc_ms" + b9.i.f16692b + str + ";" + uri2.substring(i10));
                            }
                            String encodedPath = uri.getEncodedPath();
                            int indexOf2 = uri2.indexOf(encodedPath);
                            return Uri.parse(uri2.substring(0, encodedPath.length() + indexOf2) + ";dc_ms" + b9.i.f16692b + str + ";" + uri2.substring(indexOf2 + encodedPath.length()));
                        }
            ...
            if (uri.getQueryParameter("ms") == null) {
                ...
                if (indexOf3 != -1) {
                    int i11 = indexOf3 + 1;
                    return Uri.parse(uri3.substring(0, i11) + "ms" + b9.i.f16692b + str + b9.i.f16694c + uri3.substring(i11));
                }
    ...
    @Deprecated
    public final Uri zzb(Uri uri, Context context) throws zzaud {
