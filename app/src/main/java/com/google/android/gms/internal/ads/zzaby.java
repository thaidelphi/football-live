...
public final class zzaby implements zzack {
    ...
    public zzaby(zzl zzlVar, long j10, long j11) {
        this.zzb = zzlVar;
        this.zzd = j10;
        this.zzc = j11;
    }
    ...
    public final int zzc(int i10) throws IOException {
        int zzr = zzr(1);
        if (zzr == 0) {
            zzr = zzq(this.zza, 0, Math.min(1, (int) CodedOutputStream.DEFAULT_BUFFER_SIZE), 0, true);
        }
        zzs(zzr);
        return zzr;
    }
    ...
    public final boolean zzo(int i10, boolean z10) throws IOException {
        int zzr = zzr(i10);
        while (zzr < i10 && zzr != -1) {
            zzr = zzq(this.zza, -zzr, Math.min(i10, zzr + CodedOutputStream.DEFAULT_BUFFER_SIZE), zzr, false);
        }
        zzs(zzr);
        return zzr != -1;
    }
