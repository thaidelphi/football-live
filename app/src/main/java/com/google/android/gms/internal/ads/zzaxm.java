...
public final class zzaxm implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    private static final long zzc = ((Long) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbbm.zzbv)).longValue();
    ...
    public zzaxm(Context context, View view) {
        ...
        if (applicationContext instanceof Application) {
            ...
            this.zzj = new zzaxy((Application) applicationContext, this);
        }
    ...
    */
    public final void zzj(int r35) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaxm.zzj(int):void");
    }

    private final void zzk() {
        com.google.android.gms.ads.internal.util.zzs.zza.post(new Runnable() { // from class: com.google.android.gms.internal.ads.zzaxi
    ...
    private final void zzl(View view) {
        ...
        if (application != null) {
            try {
                ...
                com.google.android.gms.ads.internal.util.client.zzo.zzh("Error registering activity lifecycle callbacks.", e8);
            }
        }
    }
    ...
    private final void zzm(View view) {
        try {
            ...
            int i10 = com.google.android.gms.ads.internal.util.zze.zza;
            com.google.android.gms.ads.internal.util.client.zzo.zzh("Error while unregistering listeners from the last ViewTreeObserver.", e8);
        }
        try {
    ...
    public final void zzd(zzaxl zzaxlVar) {
        this.zzn.add(zzaxlVar);
        zzj(3);
    }

    public final void zze(zzaxl zzaxlVar) {
        this.zzn.remove(zzaxlVar);
    }
