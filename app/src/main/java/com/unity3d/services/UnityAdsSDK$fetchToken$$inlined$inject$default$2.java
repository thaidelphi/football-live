...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$2 extends o implements a<GetInitializationState> {
    ...
    public final GetInitializationState invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, b0.b(GetInitializationState.class));
    }
}
