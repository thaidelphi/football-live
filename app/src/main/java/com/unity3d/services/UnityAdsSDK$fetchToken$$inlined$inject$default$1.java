...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$1 extends o implements a<GetHeaderBiddingToken> {
    ...
    public final GetHeaderBiddingToken invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, b0.b(GetHeaderBiddingToken.class));
    }
}
