...
final class LegacyHttpClient$executeBlocking$1 extends l implements p<o0, d<? super HttpResponse>, Object> {
    ...
    public final Object invoke(o0 o0Var, d<? super HttpResponse> dVar) {
        return ((LegacyHttpClient$executeBlocking$1) create(o0Var, dVar)).invokeSuspend(w.f26638a);
    }
