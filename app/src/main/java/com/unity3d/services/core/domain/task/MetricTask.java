...
public abstract class MetricTask<P extends BaseParams, R> implements BaseTask<P, R> {
    ...
    private final Map<String, String> getMetricTagsForState() {
        ...
        n.e(retryTags, "getInstance().retryTags");
        return retryTags;
    }

    private final SDKMetricsSender getSDKMetrics() {
        return (SDKMetricsSender) getServiceProvider().getRegistry().getService("", b0.b(SDKMetricsSender.class));
    }
    ...
    */
    public static /* synthetic */ java.lang.Object m70invokegIAlus$suspendImpl(com.unity3d.services.core.domain.task.MetricTask<? super P, R> r8, P r9, m8.d<? super i8.o<? extends R>> r10) {
        /*
        ...
        L51:
            ...
            r0.J$0 = r4
            r0.label = r3
            java.lang.Object r9 = com.unity3d.services.core.domain.task.BaseTask.DefaultImpls.m54invokegIAlus(r8, r9, r0)
            if (r9 != r1) goto L74
            return r1
        L74:
            r0 = r8
        ...
        L79:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.MetricTask.m70invokegIAlus$suspendImpl(com.unity3d.services.core.domain.task.MetricTask, com.unity3d.services.core.domain.task.BaseParams, m8.d):java.lang.Object");
    }
    ...
    public Object mo53invokegIAlus(P p10, d<? super o<? extends R>> dVar) {
        return m70invokegIAlus$suspendImpl(this, p10, dVar);
    }
