    ...
    public static class InitializeStateCleanCache extends InitializeState {
        ...
        public InitializeState execute() {
            try {
                ...
                DeviceLog.error("Failure trying to clean cache: " + e8.getMessage());
            }
    ...
    public static class InitializeStateConfig extends InitializeState {
        ...
        public InitializeState executeLegacy(Configuration configuration) {
            try {
                ...
                return new InitializeStateNetworkError(ErrorState.NetworkConfigRequest, e8, this, this._localConfig);
            }
        }
        ...
        public InitializeState executeWithLoader() {
            ...
            try {
                ...
                return new InitializeStateNetworkError(ErrorState.NetworkConfigRequest, e8, this, this._configuration);
            }
        }
    ...
    public static class InitializeStateCreate extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                ...
                return new InitializeStateError(ErrorState.CreateWebApp, e8, this._configuration);
            }
        }
    ...
    public static class InitializeStateDownloadWebView extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                ...
                DeviceLog.exception("Malformed URL", e8);
                return null;
            }
        }
    }
            ...
            try {
                ...
                if (Sha256 != null && Sha256.equals(this._configuration.getWebViewHash())) {
                    try {
                        ...
                        return new InitializeStateError(ErrorState.LoadCache, e8, this._configuration);
                    }
                }
        ...
        public InitializeState execute() {
            ...
            try {
                try {
                    ...
                    return new InitializeStateNetworkError(ErrorState.NetworkWebviewRequest, e8, this, this._configuration);
                }
            } catch (Exception e10) {
    ...
    public static class InitializeStateRetry extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                ...
                DeviceLog.exception("Init retry interrupted", e8);
        ...
        while (true) {
            try {
                ...
                try {
                    ...
                    DeviceLog.exception("Unity Ads SDK encountered an error during initialization, cancel initialization", e8);
