...
public class BaseTimer implements IBaseTimer {
    ...
    private void schedule() {
        ...
        } catch (IllegalArgumentException | IllegalStateException | NullPointerException | RejectedExecutionException e8) {
            DeviceLog.debug("ERROR: IntervalTimer failed to start due to exception " + e8.getLocalizedMessage());
        }
    }
