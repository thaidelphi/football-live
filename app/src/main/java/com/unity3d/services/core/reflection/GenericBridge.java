...
public abstract class GenericBridge {
    ...
    private Method getReflectiveMethod(Class<?> cls, String str, Class<?>... clsArr) {
        try {
            ...
            DeviceLog.debug("ERROR: Could not find method %s in %s", str, cls.getName() + " " + e8.getLocalizedMessage());
    ...
    public <T> T callNonVoidMethod(String str, Object obj, Object... objArr) {
        ...
        try {
            ...
            DeviceLog.debug("ERROR: Could not invoke method %s : %s", str, e8.getLocalizedMessage());
            return null;
        }
    }
    ...
    public Class<?> classForName() {
        try {
            ...
            DeviceLog.debug("ERROR: Could not find Class %s %s", this._className, e8.getLocalizedMessage());
            return null;
        }
    }
