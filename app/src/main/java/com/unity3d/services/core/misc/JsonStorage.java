...
public class JsonStorage implements IJsonStorageReader {
        ...
        for (int i10 = 0; i10 < split.length; i10++) {
            if (!jSONObject.has(split[i10])) {
                try {
                    ...
                    DeviceLog.exception("Couldn't create new JSONObject", e8);
                }
            } else {
                try {
    ...
    private synchronized Object findObject(String str) {
        ...
        for (int i10 = 0; i10 < split.length; i10++) {
            ...
            try {
                ...
                DeviceLog.exception("Couldn't read JSONObject: " + split[i10], e8);
                return null;
            }
        }
        return jSONObject;
    ...
    public synchronized Object get(String str) {
        ...
        try {
            ...
            DeviceLog.exception("Error getting data", e8);
        }
        return obj;
    }
            ...
            if (findObject(getParentObjectTreeFor(str)) instanceof JSONObject) {
                ...
                if (jSONObject != null) {
                    try {
                        ...
                        DeviceLog.exception("Couldn't set value", e8);
                        return false;
                    }
                }
                return true;
