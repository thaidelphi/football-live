...
public class DeviceInfo {
    ...
    public static void getApkDigest(WebViewCallback webViewCallback) {
        try {
            ...
            webViewCallback.error(DeviceError.COULDNT_GET_DIGEST, e8.toString());
        }
    }
    ...
    public static void getPackageInfo(WebViewCallback webViewCallback) {
        if (ClientProperties.getApplicationContext() != null) {
            ...
            try {
                ...
                webViewCallback.error(DeviceError.JSON_ERROR, e8.getMessage());
                return;
            }
        }
    ...
    public static void getProcessInfo(WebViewCallback webViewCallback) {
        ...
        if (processInfo != null) {
            try {
                ...
                DeviceLog.exception("Error while constructing process info", e8);
            }
        }
    ...
    private static StorageType getStorageTypeFromString(String str) {
        try {
            ...
            DeviceLog.exception("Illegal argument: " + str, e8);
            return null;
        }
    }
