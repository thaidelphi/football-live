    ...
    private HttpURLConnection getHttpUrlConnectionWithHeaders() throws NetworkIOException, IllegalArgumentException {
        ...
        if (getUrl().toString().startsWith("https://")) {
            try {
                ...
                throw new NetworkIOException("Open HTTPS connection: " + e8.getMessage());
            }
            ...
            if (getHeaders() != null && getHeaders().size() > 0) {
                for (String str : getHeaders().keySet()) {
                    for (String str2 : getHeaders().get(str)) {
                        DeviceLog.debug("Setting header: " + str + b9.i.f16692b + str2);
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        DeviceLog.exception("Error closing writer", e8);
                    }
                } catch (IOException e10) {
                ...
                if (outputStream2 != null) {
                    try {
                        ...
                        DeviceLog.exception("Error closing writer", e11);
                    }
                }
                throw th;
            }
