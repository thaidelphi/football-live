...
public class Utilities {
    ...
    public static <T> T getService(String str, Class cls) {
        return (T) ServiceProvider.INSTANCE.getRegistry().getService(str, a.c(cls));
    }
    ...
    public static void wrapCustomerListener(Runnable runnable) {
        try {
            ...
            DeviceLog.error("An uncaught exception has occurred in the client application.  Exception: %s", e8.getMessage());
        }
    }
    ...
    */
    ...
    public static String Sha256(byte[] bArr) {
        ...
        try {
            ...
            DeviceLog.exception("SHA-256 algorithm not found", e8);
            return null;
        }
    }
