...
public final class UnityAdsSDK$getToken$$inlined$inject$default$1 extends o implements a<GetGameId> {
    ...
    public final GetGameId invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, b0.b(GetGameId.class));
    }
}
