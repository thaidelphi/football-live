    ...
    public static void getMotionEventCount(JSONArray jSONArray, WebViewCallback webViewCallback) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                DeviceLog.exception("Error retrieving int from eventTypes", e8);
            }
        }
        if (getAdUnitActivity() != null) {
            if (getAdUnitActivity().getLayout() != null) {
    ...
    public static void getMotionEventData(JSONObject jSONObject, WebViewCallback webViewCallback) {
        ...
        while (true) {
            ...
            try {
                ...
                DeviceLog.exception("Couldn't fetch keyIndices", e8);
            }
            if (jSONArray != null) {
                for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                    try {
    ...
    public static void setKeyEventList(JSONArray jSONArray, WebViewCallback webViewCallback) {
        if (getAdUnitActivity() != null) {
            try {
                ...
                DeviceLog.exception("Error parsing views from viewList", e8);
                webViewCallback.error(AdUnitError.CORRUPTED_KEYEVENTLIST, jSONArray, e8.getMessage());
                return;
            }
        }
        webViewCallback.error(AdUnitError.ADUNIT_NULL, new Object[0]);
                ...
                public void run() {
                    if (AdUnit.getAdUnitActivity() != null) {
                        try {
                            ...
                            DeviceLog.exception("Corrupted viewlist", e8);
                        }
                    }
                }
            });
    ...
    public static void open(Integer num, JSONArray jSONArray, Integer num2, JSONArray jSONArray2, Integer num3, Boolean bool, Boolean bool2, Integer num4, WebViewCallback webViewCallback) {
        ...
        if (num != null) {
            try {
                ...
                try {
                    ...
                    if (jSONArray2 != null) {
                        try {
                            ...
                            DeviceLog.exception("Error parsing views from viewList", e8);
                            webViewCallback.error(AdUnitError.CORRUPTED_KEYEVENTLIST, jSONArray2, e8.getMessage());
                            return;
                        }
                    }
                ...
                webViewCallback.error(AdUnitError.ACTIVITY_ID, Integer.valueOf(num.intValue()), e11.getMessage());
                return;
            }
        }
