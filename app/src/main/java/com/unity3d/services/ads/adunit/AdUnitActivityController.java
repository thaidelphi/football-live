...
public class AdUnitActivityController {
    ...
    public void onRequestPermissionsResult(int i10, String[] strArr, int[] iArr) {
        try {
            ...
            this._eventSender.sendEvent(WebViewEventCategory.PERMISSIONS, PermissionsEvent.PERMISSIONS_ERROR, e8.getMessage());
        }
    }
    ...
    public void setLayoutInDisplayCutoutMode(int i10) {
        ...
        try {
            ...
            DeviceLog.debug("Error setting layoutInDisplayCutoutMode", e8);
    ...
    public boolean setSystemUiVisibility(int i10) {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            try {
                ...
                DeviceLog.exception("Error while setting SystemUIVisibility", e8);
            }
        }
        return false;
    }
