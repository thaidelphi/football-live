...
public class WebPlayerView extends WebView {
        ...
        public void run() {
            ...
            if (str != null) {
                try {
                    ...
                    DeviceLog.exception("Error while processing JavaScriptString", e8);
                    return;
                }
            }
    ...
    public WebPlayerView(Context context, String str, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        if (i10 >= 19) {
            try {
                ...
                DeviceLog.exception("Method evaluateJavascript not found", e8);
                this._evaluateJavascript = null;
            }
        }
    ...
    public <T> T getReturnValue(String str, Class<T> cls, T t10) {
        try {
            ...
            DeviceLog.exception("Error getting default return value", e8);
        }
        return t10;
    }
    ...
    private Object[] getValues(JSONArray jSONArray) throws JSONException, ClassNotFoundException, NoSuchMethodException {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            if (jSONArray.get(i10) instanceof JSONObject) {
                ...
                Object obj = jSONObject.get(b9.h.X);
        ...
        if (jSONObject != null) {
            ...
            while (keys.hasNext()) {
                ...
                try {
                    ...
                    addErroredSetting(next, e8.getMessage());
                    DeviceLog.exception("Setting errored", e8);
                }
            }
        }
        return obj;
    ...
    public boolean shouldCallSuper(String str) {
        try {
            ...
            DeviceLog.exception("Error getting super call status", e8);
            return true;
        }
    }
    ...
    public boolean shouldSendEvent(String str) {
        try {
            ...
            DeviceLog.exception("Error getting send event status", e8);
            return false;
        }
    }
