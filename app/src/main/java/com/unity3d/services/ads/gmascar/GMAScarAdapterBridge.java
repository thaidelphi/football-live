...
public class GMAScarAdapterBridge {
    ...
    private void loadInterstitialAd(u7.c cVar) {
    ...
    private void loadRewardedAd(u7.c cVar) {
    ...
    public void getSCARBiddingSignals(List<d> list, BiddingSignalsHandler biddingSignalsHandler) {
        ...
        if (mobileAdsBridgeBase != null && mobileAdsBridgeBase.hasSCARBiddingSupport()) {
            ...
            if (scarAdapterObject != null) {
                scarAdapterObject.a(ClientProperties.getApplicationContext(), list, biddingSignalsHandler);
                return;
            } else {
    ...
    public void getSCARSignal(String str, d dVar) {
        ...
        if (fVar != null) {
            fVar.b(ClientProperties.getApplicationContext(), str, dVar, signalsHandler);
        } else {
    ...
    public void load(boolean z10, String str, String str2, String str3, String str4, int i10) {
        u7.c cVar = new u7.c(str, str2, str4, str3, Integer.valueOf(i10));
        f scarAdapterObject = getScarAdapterObject();
        this._scarAdapter = scarAdapterObject;
        if (scarAdapterObject == null) {
    ...
    public void loadBanner(Context context, BannerView bannerView, String str, u7.c cVar, UnityBannerSize unityBannerSize) {
        this._scarAdapter = getScarAdapterObject();
        ScarBannerAdHandler scarBannerAdHandler = new ScarBannerAdHandler(this._gmaEventSender, str);
        f fVar = this._scarAdapter;
        if (fVar != null) {
            fVar.f(context, bannerView, cVar, unityBannerSize.getWidth(), unityBannerSize.getHeight(), scarBannerAdHandler);
        } else {
    ...
    public void show(String str, String str2) {
        u7.c cVar = new u7.c(str, str2);
        f scarAdapterObject = getScarAdapterObject();
        this._scarAdapter = scarAdapterObject;
        if (scarAdapterObject != null) {
            scarAdapterObject.e(ClientProperties.getActivity(), str2, str);
        } else {
    ...
    public void getSCARBiddingSignals(boolean z10, BiddingSignalsHandler biddingSignalsHandler) {
        ...
        if (mobileAdsBridgeBase != null && mobileAdsBridgeBase.hasSCARBiddingSupport()) {
            ...
            this._scarAdapter = scarAdapterObject;
            if (scarAdapterObject != null) {
                scarAdapterObject.c(ClientProperties.getApplicationContext(), z10, biddingSignalsHandler);
                return;
            } else {
                biddingSignalsHandler.onSignalsCollectionFailed("Could not create SCAR adapter object.");
                return;
