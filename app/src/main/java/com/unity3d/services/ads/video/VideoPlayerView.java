...
public class VideoPlayerView extends VideoView {
    ...
    public void pause() {
        try {
            ...
            DeviceLog.exception("Error pausing video", e8);
        }
    }
    ...
    public boolean prepare(String str, final float f10, int i10) {
        ...
        try {
            ...
            DeviceLog.exception("Error preparing video: " + this._videoUrl, e8);
            return false;
        }
    }
    ...
    public void seekTo(int i10) {
        try {
            ...
            DeviceLog.exception("Error seeking video", e8);
        }
    }
    ...
    public void setVolume(Float f10) {
        try {
            ...
            DeviceLog.exception("MediaPlayer generic error", e8);
        }
    }
