...
public class Store {
    ...
    public static void getSkuDetails(Integer num, String str, JSONArray jSONArray, WebViewCallback webViewCallback) {
        ...
        try {
            ...
            WEB_VIEW_STORE_EXCEPTION_HANDLER.handleStoreException(StoreEvent.SKU_DETAILS_LIST_REQUEST_ERROR, num.intValue(), e8);
        }
        webViewCallback.invoke(new Object[0]);
    }
    ...
    public static void initialize(WebViewCallback webViewCallback) {
        try {
            ...
            webViewCallback.error(StoreError.UNKNOWN_ERROR, e8.getMessage(), e8.getClass().getName());
        }
    }
    ...
    public static void startPurchaseTracking(JSONArray jSONArray, WebViewCallback webViewCallback) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                webViewCallback.error(StoreError.JSON_ERROR, e8.getMessage());
                return;
            }
        }
