...
public final class AndroidDeviceInfoRepository$getAuidByteString$1 extends d {
    int label;
    ...
    public AndroidDeviceInfoRepository$getAuidByteString$1(AndroidDeviceInfoRepository androidDeviceInfoRepository, m8.d<? super AndroidDeviceInfoRepository$getAuidByteString$1> dVar) {
        super(dVar);
