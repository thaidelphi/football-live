...
final class HandleInvocationsFromAdViewer$invoke$definition$40 extends o implements t8.a<ExposedFunction> {
    ...
    HandleInvocationsFromAdViewer$invoke$definition$40() {
        super(0);
    }
