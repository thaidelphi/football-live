...
public final class DiagnosticEventJob$special$$inlined$inject$default$2 extends o implements a<DiagnosticEventRequestWorkModifier> {
    ...
    public final DiagnosticEventRequestWorkModifier invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, b0.b(DiagnosticEventRequestWorkModifier.class));
    }
}
