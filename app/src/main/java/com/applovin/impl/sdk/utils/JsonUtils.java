...
public class JsonUtils {
    ...
    public static double getDouble(JSONObject jSONObject, String str, double d10) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve double property for key = " + str, e8);
            return d10;
        }
    }
    ...
    public static float getFloat(JSONObject jSONObject, String str, float f10) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve float property for key = " + str, e8);
            return f10;
        }
    }
    ...
    public static int getInt(JSONObject jSONObject, String str, int i10) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve int property for key = " + str, e8);
            return i10;
        }
    }
    ...
    public static JSONArray getJSONArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve JSON array for key = " + str, e8);
            return jSONArray;
        }
    }
    ...
    public static long getLong(JSONObject jSONObject, String str, long j10) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve long property for key = " + str, e8);
            return j10;
        }
    }
    ...
    public static Object getObject(JSONObject jSONObject, String str, Object obj) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve Object for key = " + str, e8);
            return obj;
        }
    }
    ...
    public static Object getObjectAtIndex(JSONArray jSONArray, int i10, Object obj) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve object at index " + i10 + " for JSON array", e8);
            return obj;
        }
    }
    ...
    public static String getString(JSONObject jSONObject, String str, String str2) {
        if (jSONObject != null) {
            try {
                ...
                n.b("JsonUtils", "Failed to retrieve string property for key = " + str, e8);
                return str2;
            }
        }
        return str2;
    ...
    public static JSONObject jsonObjectFromJsonString(String str, JSONObject jSONObject) {
        try {
            ...
            n.b("JsonUtils", "Failed to convert JSON string '" + str + "' to JSONObject", e8);
            return jSONObject;
        }
    }
    ...
    public static void putBoolean(JSONObject jSONObject, String str, boolean z10) {
        if (jSONObject != null) {
            try {
                ...
                n.b("JsonUtils", "Failed to put boolean property for key = " + str, e8);
            }
        }
    }
    ...
    public static void putDouble(JSONObject jSONObject, String str, double d10) {
        if (jSONObject != null) {
            try {
                ...
                n.b("JsonUtils", "Failed to put double property for key = " + str, e8);
            }
        }
    }
    ...
    public static void putInt(JSONObject jSONObject, String str, int i10) {
        if (jSONObject != null) {
            try {
                ...
                n.b("JsonUtils", "Failed to put int property for key = " + str, e8);
            }
        }
    }
    ...
    public static void putJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        if (jSONObject != null) {
            try {
                ...
                n.b("JsonUtils", "Failed to put JSON property for key = " + str, e8);
            }
        }
    }
    ...
    public static void putJsonArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        if (jSONObject != null) {
            try {
                ...
                n.b("JsonUtils", "Failed to put JSONArray property for key = " + str, e8);
            }
        }
    }
    ...
    public static void putLong(JSONObject jSONObject, String str, long j10) {
        if (jSONObject != null) {
            try {
                ...
                n.b("JsonUtils", "Failed to put long property for key = " + str, e8);
            }
        }
    }
    ...
    public static void putObject(JSONObject jSONObject, String str, Object obj) {
        if (jSONObject != null) {
            try {
                ...
                n.b("JsonUtils", "Failed to put Object property for key = " + str, e8);
            }
        }
    }
    ...
    public static void putString(JSONObject jSONObject, String str, String str2) {
        if (jSONObject != null) {
            try {
                ...
                n.b("JsonUtils", "Failed to put String property for key = " + str, e8);
            }
        }
    }
    ...
    public static JSONObject getJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve JSON property for key = " + str, e8);
            return jSONObject2;
        }
    }
    ...
    public static JSONObject getJSONObject(JSONArray jSONArray, int i10, JSONObject jSONObject) {
        ...
        try {
            ...
            n.b("JsonUtils", "Failed to retrieve JSON object from array for index = " + i10, e8);
            return jSONObject;
        }
    }
    ...
    public static Map<String, Object> toStringObjectMap(String str) {
        try {
            ...
            n.b("JsonUtils", "Failed to convert json string '" + str + "' to map", e8);
            return new HashMap();
        }
    }
