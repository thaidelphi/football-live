...
public class BundleUtils {
    ...
    public static JSONObject toJSONObject(Bundle bundle) {
        ...
        try {
            ...
            n.c("AppLovinSdk", "Failed to convert Bundle to JSONObject", e8);
        }
        return jSONObject;
    }
    ...
    public static boolean getBoolean(String str, boolean z10, Bundle bundle) {
        if (!TextUtils.isEmpty(str) && bundle != null && bundle.containsKey(str)) {
            ...
            if (obj instanceof Number) {
                ...
                if (str2.equalsIgnoreCase(com.ironsource.mediationsdk.metadata.a.f18924g) || str2.equalsIgnoreCase("1")) {
                    return true;
                }
