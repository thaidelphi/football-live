...
public abstract class CommunicatorMessageImpl extends Intent {
    ...
    public CommunicatorMessageImpl(Bundle bundle, String str, AppLovinCommunicatorPublisher appLovinCommunicatorPublisher) {
        super(str);
        this.f6776a = UUID.randomUUID().toString();
    ...
    public String toString() {
        return "AppLovinCommunicatorMessage{publisherId=" + getPublisherId() + ", topic=" + getTopic() + "', uniqueId='" + this.f6776a + "', data=" + this.data + ", sticky=" + this.sticky + '}';
    }
