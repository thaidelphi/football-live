...
public class AppLovinAdapterRewardedListener implements g2, AppLovinAdRewardListener, AppLovinAdVideoPlaybackListener, AppLovinAdClickListener, f2 {
    ...
    public void onAdDisplayFailed(String str) {
        ...
        this.listener.onRewardedAdDisplayFailed(new MaxAdapterError((int) MaxAdapterError.ERROR_CODE_UNSPECIFIED, str), AppLovinMediationAdapter.getExtraInfo(this.parentAdapter.loadedRewardedAd, false));
    }
