...
public class AppLovinAdapterAppOpenListener implements g2, AppLovinAdClickListener, f2 {
    ...
    public void onAdDisplayFailed(String str) {
        ...
        this.listener.onAppOpenAdDisplayFailed(new MaxAdapterError((int) MaxAdapterError.ERROR_CODE_AD_DISPLAY_FAILED, str), AppLovinMediationAdapter.getExtraInfo(this.parentAdapter.loadedAppOpenAd, false));
    }
}
