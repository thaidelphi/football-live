...
public class AppLovinAdapterInterstitialListener implements g2, AppLovinAdClickListener, f2 {
    ...
    public void adDisplayed(AppLovinAd appLovinAd) {
        ...
        if (appLovinAd instanceof com.applovin.impl.sdk.ad.b) {
            extraInfo.putBundle("applovin_ad_view_info", ((com.applovin.impl.sdk.ad.b) appLovinAd).e());
        }
    ...
    public void onAdDisplayFailed(String str) {
        ...
        this.listener.onInterstitialAdDisplayFailed(new MaxAdapterError((int) MaxAdapterError.ERROR_CODE_UNSPECIFIED, str), AppLovinMediationAdapter.getExtraInfo(this.parentAdapter.loadedInterstitialAd, false));
    }
}
