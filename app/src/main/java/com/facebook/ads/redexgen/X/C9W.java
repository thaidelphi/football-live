...
public final class C9W {
    ...
    public static void A03(File file) throws IOException {
        if (file.exists() || file.mkdir()) {
            ...
            throw new RuntimeException(format) { // from class: com.facebook.ads.redexgen.X.9X
            };
        }
        final String format2 = String.format(Locale.US, A01(33, 31, 59), file.getCanonicalPath());
        throw new RuntimeException(format2) { // from class: com.facebook.ads.redexgen.X.9X
        };
    }
