...
public abstract class AbstractC04783a {
    ...
    public static final AtomicReference<InterfaceC04803c> A05;
    ...
    public static void A02(final String str, Bundle bundle) {
        ...
        if (0 != 0) {
            ...
            ExecutorC0712Cx.A00(new Runnable() { // from class: com.facebook.ads.redexgen.X.3Z
                public static byte[] A02;
