...
public class C1855jI<K> implements Iterator<K> {
    ...
    public C1855jI(final C4X this$1, final Iterator val$entryIterator) {
        this.A01 = this$1;
    ...
    public final void remove() {
        AbstractC1790iD.A0F(this.A00 != null, A00(0, 50, 26));
