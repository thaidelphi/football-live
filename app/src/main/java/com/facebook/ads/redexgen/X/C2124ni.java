...
public final class C2124ni {
    ...
    public final String A02(NS ns) {
        String obj = ns.getClass().getGenericInterfaces()[0].toString();
        String A002 = A00(0, 21, 12);
        return obj.startsWith(A002) ? obj.substring(A002.length()) : obj;
    }

    public final String A03(AbstractC04421q abstractC04421q) {
        return A02(abstractC04421q);
    }
}
