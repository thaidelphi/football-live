...
public final class C1897jy extends C8I {
    ...
    static {
        ...
        A04 = new C8C[]{A03, A02};
        A08 = C1897jy.class.getSimpleName();
        C8C[] c8cArr = A04;
        String A002 = A00(178, 6, 85);
        A06 = C8I.A02(A002, c8cArr);
        A07 = C8I.A03(A002, A04, A02);
        A05 = A00(5, 71, 80) + A03.A01 + A00(0, 3, 56) + A00(159, 6, 69) + A00(4, 1, 103) + C1898jz.A09.A01 + A00(3, 1, 99);
    }

    public C1897jy(C8E c8e) {
        super(c8e);
    }

    @Override // com.facebook.ads.redexgen.X.C8I
    ...
    public final void A0D(C1899k0 c1899k0) {
        try {
            A05().execSQL(A05);
        } catch (SQLException e8) {
            C8A A052 = c1899k0.A05();
