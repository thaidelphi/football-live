...
public abstract class AbstractC2128nm {
    ...
    public static final Object[] A02(Collection<?> collection) {
        C2126nk.A09(collection, A00(0, 10, 17));
        ...
        while (true) {
            ...
            if (i11 >= length) {
                ...
                C2126nk.A08(objArr, A002);
                i10 = i11;
            } else if (!it.hasNext()) {
                Object[] copyOf = Arrays.copyOf(objArr, i11);
                C2126nk.A08(copyOf, A002);
                return copyOf;
            } else {
                i10 = i11;
            }
                ...
                if (!it.hasNext()) {
                    ...
                    if (size$iv != $i$f$toArrayImpl2) {
                        ...
                        if (size <= length) {
                            ...
                            C2126nk.A07(newInstance, A00(21, 62, 11));
