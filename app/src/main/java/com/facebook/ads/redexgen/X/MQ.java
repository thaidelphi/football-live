...
public final class MQ {
    ...
    @JvmStatic
    public static final List<MP> A01(String str) throws JSONException {
        C2126nk.A09(str, A00(29, 13, 101));
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            for (int i11 = 0; i11 < length2; i11++) {
                ...
                C2126nk.A06(string);
                arrayList.add(new MP(string, j10, j11, mo, new MN(jSONObject3.getDouble(A00(69, 9, 118)), jSONObject3.getDouble(A00(78, 9, 61)), jSONObject3.getDouble(A00(56, 13, 67)), jSONObject3.getDouble(A00(42, 14, 35)), jSONObject3.getDouble(A00(87, 15, 35)))));
            }
        }
        return arrayList;
    }
