...
public final class JL {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x00a3, code lost:
        return new com.facebook.ads.redexgen.X.JM(com.facebook.ads.redexgen.X.EnumC04291d.A0G);
     */
    ...
    */
    public static com.facebook.ads.redexgen.X.JM A0E(android.view.View r7, int r8, com.facebook.ads.redexgen.X.C1900k1 r9) {
        /*
            Method dump skipped, instructions count: 659
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.JL.A0E(android.view.View, int, com.facebook.ads.redexgen.X.k1):com.facebook.ads.redexgen.X.JM");
    }
    ...
    public final synchronized String A0R() {
        return EnumC04291d.values()[this.A05.A01()].toString() + String.format(Locale.US, A0H(0, 9, 46), Float.valueOf(this.A05.A00() * 100.0f));
    }
    ...
    public JL(View view, int i10, int i11, boolean z10, WeakReference<JK> weakReference, C1900k1 c1900k1) {
        this.A0B = new Handler();
        this.A01 = 0;
        this.A02 = 1000;
        this.A08 = true;
        this.A05 = new JM(EnumC04291d.A0L);
    ...
    public JL(View view, int i10, WeakReference<JK> weakReference, C1900k1 c1900k1) {
        this(view, i10, 0, false, weakReference, c1900k1);
    }

    public JL(View view, int i10, boolean z10, WeakReference<JK> weakReference, C1900k1 c1900k1) {
        this(view, i10, 0, z10, weakReference, c1900k1);
    }
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int indexOfChild = viewGroup.indexOfChild(view) + 1; indexOfChild < viewGroup.getChildCount(); indexOfChild++) {
            ...
            int childIndex = 1;
            boolean z10 = !(childAt instanceof C0830Hl);
            if ((childAt instanceof C1613fH) && JN.A00(childAt)) {
                childIndex = 0;
            }
            if (z10 && childIndex != 0) {
    ...
    */
    public static java.util.Vector<android.graphics.Rect> A0L(android.view.View r5) {
        ...
        L15:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.JL.A0H
            r0 = 0
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 13
            if (r1 == r0) goto L85
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.JL.A0H
        ...
        L50:
            ...
            if (r0 == 0) goto L76
            boolean r0 = com.facebook.ads.redexgen.X.JN.A00(r5)
            if (r0 != 0) goto L5c
            if (r1 == 0) goto L76
        L5c:
        ...
        L85:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.JL.A0L(android.view.View):java.util.Vector");
    }
    ...
    public final synchronized Map<String, String> A0S() {
        ...
        hashMap.put(A0H(592, 2, 13), C0709Cu.A06(this.A03));
    ...
    public final synchronized void A0U() {
        ...
        this.A04 = new C0825Hg(this, this.A0D);
