...
public class C4F<K, V> {
    ...
    */
    public final V A0A(int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C4F.A0A(int):java.lang.Object");
    }
        ...
        if (obj instanceof C4F) {
            ...
            for (int i10 = 0; i10 < this.A00; i10++) {
                try {
                    K A09 = A09(i10);
                    V A0B = A0B(i10);
                    Object obj2 = c4f.get(A09);
                    if (A0B == null) {
                        if (obj2 == null && c4f.containsKey(A09)) {
                        }
                        return false;
    ...
    public static int A02(int[] iArr, int i10, int i11) {
        try {
            return AnonymousClass45.A02(iArr, i10, i11);
