...
public final class C1649fr extends AbstractC0786Ft {
    ...
    public final C0790Fx A0C;
    public final AbstractC1415c3 A0D;
    public final AbstractC1407bv A0E;
    ...
    public C1649fr(C0790Fx c0790Fx) {
        super(c0790Fx, false);
    ...
    private LinearLayout A00() {
        ...
        String A0B = this.A0C.A04().A1b().A0G().A0B();
        String A01 = this.A0C.A04().A1b().A0G().A01();
        String A05 = this.A0C.A04().A1b().A0G().A05();
        if (!TextUtils.isEmpty(A0B)) {
            DB db = DB.RATINGS;
            AbstractC2058md A04 = this.A0C.A04();
            String[] strArr = A0F;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            A0F[2] = "";
            LinearLayout videoMetaDataLayout = A01(db, A04.A1b().A0G().A0B());
    ...
    private LinearLayout A01(DB db, String str) {
        ...
        linearLayout.setLayoutParams(layoutParams);
        D3.A0Q(linearLayout, D3.A06(RecyclerView.UNDEFINED_DURATION, A0Q));
    ...
    private final RelativeLayout A02(String str, int i10, DB db) {
        ...
        D3.A0Q(relativeLayout, D3.A06(i10, A0G));
    ...
    private C1433cL A05() {
        C1433cL c1433cL = new C1433cL(this.A0C.A05());
        D3.A0Q(c1433cL, D3.A06(436207616, A0Q));
        c1433cL.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
        this.A05 = new C0898Kb(this.A0B, getAdEventManager(), c1433cL, this.A0C.A04().A1g(), 0, 0, true, null, null);
        if (C06419m.A1t(this.A0B)) {
            this.A03 = new C1438cQ(this.A0B, getAdEventManager(), c1433cL, this.A0C.A04().A1g(), this.A05, null);
        } else {
            this.A03 = null;
        }
        return c1433cL;
    ...
    private void A08() {
        ...
        AbstractC0779Fm.A00(this.A0C.A05(), this, this.A0C.A04().A1b().A0F().A08());
    ...
    public final void A1A(C0898Kb c0898Kb) {
        if (this.A05 != null) {
            this.A05.A0o(c0898Kb);
        }
    }
