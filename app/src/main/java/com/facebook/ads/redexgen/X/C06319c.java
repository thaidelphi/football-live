...
public final class C06319c {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized C9T A06(int i10, byte[] bArr, int i11, int[] iArr, int i12) throws IOException {
        C06309b A00 = A00();
        int i13 = 1;
        if (i10 >= 0) {
            int i14 = i10;
            ...
            if (i14 <= i10) {
                return new C9T(z10 ? C9S.A04 : C9S.A05, i10, i10, 0);
            }
            A00.A02.seek(j10);
            A00.A02.read(bArr, i11, i15);
            return new C9T(C9S.A03, i10, i14, i15);
        }
    ...
    public C06319c(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C06309b.A03(file);
        } else if (!file.isFile()) {
            throw new IOException(String.format(Locale.US, A01(25, 32, 2), file.getCanonicalPath()));
        }
    }

    private C06309b A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C06309b.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i10, long j10) throws IOException {
        ...
        this.A00.A02.seek(C06309b.A02(i10));
