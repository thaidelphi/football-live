...
public final class C5Q {
    ...
    public final int A07(View view) {
        int A9x = this.A01.A9x(view);
        if (A9x == -1 || this.A00.A08(A9x)) {
            return -1;
        }
        int index = this.A00.A03(A9x);
        return A9x - index;
    }
    ...
    public final View A08(int i10) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            C6K A7B = this.A01.A7B(view);
            int count = A7B.A0I();
            if (count == i10 && !A7B.A0Z() && !A7B.A0a()) {
                return view;
            }
        }
        return null;
    ...
    public final View A09(int i10) {
        return this.A01.A77(A00(i10));
    }

    public final View A0A(int i10) {
        return this.A01.A77(i10);
    }
    ...
    public final void A0H(View view, int i10, ViewGroup.LayoutParams layoutParams, boolean z10) {
        ...
        this.A01.A4A(view, A00, layoutParams);
    }
