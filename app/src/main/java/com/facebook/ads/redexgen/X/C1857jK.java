...
public class C1857jK<V> extends AbstractCollection<V> {
    ...
    public C1857jK(@ParametricNullness final C4U this$0, @CheckForNull Object key, Collection delegate, C1857jK ancestor) {
        this.A04 = this$0;
        this.A02 = key;
        this.A00 = delegate;
        this.A01 = ancestor;
    ...
    public final boolean remove(@CheckForNull Object o10) {
        A04();
        boolean remove = this.A00.remove(o10);
        if (remove) {
            C4U.A01(this.A04);
            A05();
        }
