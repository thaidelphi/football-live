...
public final class C6 {
    ...
    public static int A00(C1900k1 c1900k1, int i10) {
        return BJ.A00(c1900k1).getInt(A01(0, 21, 52), i10);
    }

    public static String A02(C1900k1 c1900k1, String str) {
        int A002 = A00(c1900k1, -1);
        if (A002 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C1900k1 c1900k1, String str, String str2) {
        if (c1900k1 == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c1900k1, str);
    ...
    public final RewardedVideoAd A07(C1900k1 c1900k1, String str, String str2) {
        if (c1900k1 == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c1900k1, str);
    ...
    public final void A08(C1900k1 c1900k1, boolean z10) {
        int i10 = 0;
        String A01 = A01(0, 21, 52);
        if (!z10) {
            int lastNonChainedAds = BJ.A00(c1900k1).getInt(A01, 0);
            i10 = lastNonChainedAds + 1;
        }
        BJ.A00(c1900k1).edit().putInt(A01, i10).apply();
    }

    public final boolean A09(C1900k1 c1900k1, String str, int i10) {
        if (i10 <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c1900k1, i10 - 1);
