...
public final class C1861jO<T> implements C9Z<T> {
    ...
    public C9R A00;
    public C9R A01;
    public List<C1861jO<T>.RecordFileBasedFetch> A02 = new ArrayList();
    public boolean A03;
    public final C9Q A04;
    public final C06359g A05;
    ...
    public synchronized boolean A06(C1862jP c1862jP) {
        if (this.A02.remove(c1862jP)) {
            if (c1862jP.A6N() > 0 && c1862jP.A01().A02.A05(c1862jP.A01().A01).equals(this.A01)) {
                this.A01 = c1862jP.A00().A02;
            }
            return true;
        }
        return false;
    ...
    public C1861jO(C9W c9w, InterfaceC06339e interfaceC06339e) throws IOException {
        this.A05 = new C06359g(c9w.A04(A00(IronSourceConstants.SDK_INIT_FAILED, 4, 103)), interfaceC06339e);
        this.A04 = new C9Q(new File(c9w.A05(), A00(IronSourceError.ERROR_CODE_NO_ADS_TO_SHOW, 6, 60)));
        this.A00 = this.A04.A03();
        A05(interfaceC06339e);
        this.A01 = this.A00;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jO != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    private void A02(int i10, int i11) throws IOException {
        this.A00 = new C9R(i10, i11);
    ...
    public synchronized void A03(C1862jP c1862jP) throws C06379i {
        if (!this.A03) {
            if (A06(c1862jP)) {
                if (c1862jP.A6N() == 0) {
                    return;
                }
                if (this.A00.A04(c1862jP.A00().A02) == 0) {
                    try {
                        for (C06329d c06329d : c1862jP.A00) {
                            if (c06329d.A00 == this.A05.A07() && this.A05.A0D()) {
                                A02(this.A05.A06(), 0);
                            } else {
                                A02(this.A05.A06(), c1862jP.A00().A00);
                                break;
                            }
                        }
                        ...
                        throw new C06379i(A00(361, 30, 22), e8);
                    }
                }
                throw new C06379i(A00(0, 54, 30));
            }
            throw new C06379i(A00(466, 43, 59));
        }
        throw new C06379i(A00(427, 39, 60));
    }
    ...
    */
    private void A05(com.facebook.ads.redexgen.X.InterfaceC06339e r13) throws java.io.IOException {
        /*
            r12 = this;
            com.facebook.ads.redexgen.X.9g r0 = r12.A05
            int r0 = r0.A06()
            r5 = 0
            com.facebook.ads.redexgen.X.9R r3 = new com.facebook.ads.redexgen.X.9R
            r3.<init>(r0, r5)
            com.facebook.ads.redexgen.X.9R r0 = r12.A00
            int r0 = r3.A04(r0)
            r4 = 3
            r11 = 2
            r10 = 1
        ...
        L7c:
            ...
            r0.<init>(r2, r1)
            r12.A00 = r0
            com.facebook.ads.redexgen.X.9Q r1 = r12.A04
            com.facebook.ads.redexgen.X.9R r0 = r12.A00
            r1.A04(r0)
            goto L5c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1861jO.A05(com.facebook.ads.redexgen.X.9e):void");
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jO != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jP != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T>$RecordFileBasedFetch */
    @Override // com.facebook.ads.redexgen.X.C9Z
    public final synchronized C9Y A6M(byte[] bArr, int[] iArr) throws C06379i {
        C1861jO<T>.RecordFileBasedFetch c1862jP;
        if (!this.A03) {
            int i10 = 0;
            int i11 = 0;
            try {
                ...
                while (true) {
                    C9U A0A = this.A05.A0A(this.A01.A02(), this.A01.A03(), bArr, i10, iArr, i11);
                    int A00 = A0A.A01().A00();
                    ...
                    i10 += storageOffset2;
                    i11 += i12;
                    if (A0A.A01().A03() == C9S.A03) {
                        arrayList.add(A0A);
                    }
                    if (A0A.A01().A03() == C9S.A04) {
                        break;
                    } else if (A0A.A01().A03() == C9S.A05) {
                ...
                c1862jP = new C1862jP(this, arrayList, mayHaveMoreData);
                this.A02.add(c1862jP);
                if (!arrayList.isEmpty()) {
                    C9R c9r = c1862jP.A01().A02;
                    int storageOffset6 = c1862jP.A01().A01;
                    this.A01 = c9r.A05(storageOffset6);
                }
            } catch (IOException e8) {
                throw new C06379i(A00(306, 29, 84), e8);
            }
        } else {
            throw new C06379i(A00(391, 36, 123));
        }
        return c1862jP;
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jO != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.X.C9Z
    public final synchronized int A8i() throws C06379i {
        int A09;
        if (!this.A03) {
            try {
                A09 = this.A05.A09();
                ...
                throw new C06379i(A00(335, 26, 57), e8);
            }
        } else {
            throw new C06379i(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jO != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.X.C9Z
    public final synchronized void AJM(byte[] bArr) throws C06379i {
        if (!this.A03) {
            try {
                this.A05.A0C(bArr);
            } catch (IOException e8) {
                throw new C06379i(A00(257, 25, 62), e8);
            }
        } else {
            throw new C06379i(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jO != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.X.C9Z
    public final synchronized void clear() throws C06379i {
        try {
            this.A05.A0B();
            A02(this.A05.A06(), 0);
            this.A02.clear();
        } catch (IOException e8) {
            throw new C06379i(A00(282, 24, 87), e8);
        }
    }
