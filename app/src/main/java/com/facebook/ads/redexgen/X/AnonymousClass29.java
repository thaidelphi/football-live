...
public final class AnonymousClass29 {
     ...
     */
    public final synchronized void A0A(String str) throws JSONException, C06058b {
        if (str != null) {
            if (!str.trim().isEmpty()) {
    ...
    private final synchronized C04582g A00(String str, JSONObject jSONObject) throws JSONException, C06058b {
        C04582g frequencyCappingData;
        if (str.equals(jSONObject.optString(A01(29, 12, 70), null))) {
            frequencyCappingData = new C04582g(str);
            A03(frequencyCappingData, jSONObject);
        } else {
            C06058b c06058b = new C06058b(new IllegalArgumentException());
    ...
    private void A03(C04582g c04582g, JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.has(A01)) {
            c04582g.A06((JSONArray) jSONObject.get(A01));
        }
        String A012 = A01(81, 20, 107);
        if (jSONObject.has(A012)) {
            int cappingTimeSecs = jSONObject.optInt(A012);
            c04582g.A04(cappingTimeSecs);
        }
        c04582g.A05(optInt, optInt2, optLong, maxCappedArrayLength);
    }
    ...
    public final synchronized void A08(String str) throws JSONException {
        if (str != null) {
            if (!str.trim().isEmpty()) {
                ...
                for (int i10 = 0; i10 < jSONArray.length() && i10 < C04582g.A00(); i10++) {
    ...
    public final synchronized void A0B(JSONObject jSONObject) throws JSONException {
        ...
        if (this.A00.has(optString) && (this.A00.get(optString) instanceof C04582g)) {
            frequencyCappingData = (C04582g) this.A00.get(optString);
        } else {
            frequencyCappingData = new C04582g(optString);
        }
        A03(frequencyCappingData, jSONObject);
