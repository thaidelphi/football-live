...
public class C1778hz implements DI {
    ...
    public C1778hz(Executor executor, C06238t c06238t, C1900k1 c1900k1) {
        this.A00 = c1900k1.A02();
        this.A02 = C0880Jj.A01(this.A00);
        this.A03 = executor;
        this.A01 = c06238t;
    }
    ...
    public Map<String, String> A02(String str) {
        ...
        C0876Jf c0876Jf2 = new C0876Jf();
        C0876Jf c0876Jf3 = new C0876Jf();
        c0876Jf.put(A03(257, 15, 52), C7V.A00().A03());
        c0876Jf.put(A03(220, 9, 15), A03(15, 15, 91));
        c0876Jf.put(A03(186, 11, 79), A03(0, 15, 101));
        c0876Jf.put(A03(174, 12, 79), A03(30, 48, 92));
        c0876Jf.put(A03(197, 11, 121), (System.currentTimeMillis() / 1000) + A03(0, 0, 108));
        String A09 = this.A01.A09();
        if (A09 != null) {
            c0876Jf3.put(A03(208, 12, 53), A09);
        }
        c0876Jf2.put(A03(229, 11, 80), str);
        c0876Jf2.put(A03(248, 9, 97), CV.A01(c0876Jf3));
        c0876Jf.A04(A03(240, 8, 119), CV.A01(c0876Jf2));
        return c0876Jf;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A07(C06238t c06238t) {
        this.A01 = c06238t;
    }
