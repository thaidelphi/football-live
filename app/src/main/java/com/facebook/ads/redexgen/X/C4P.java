...
public final class C4P {
    ...
    public final void A03(int i10) {
        ...
        if (A00 != null) {
            AbstractC05254x.A02(A00, this.A04, i10);
            A01(i10, null);
        }
    }
    ...
    public final boolean A07(float f10, float f11) {
        ...
        return AbstractC05254x.A06(A00, this.A04, f10, f11);
    }
    ...
    public final boolean A08(float f10, float f11, boolean z10) {
        ...
        return AbstractC05254x.A07(A00, this.A04, f10, f11, z10);
    }
    ...
    public final boolean A0B(int i10, int i11) {
        ...
        if (A06()) {
            ...
            for (ViewParent parent = this.A04.getParent(); parent != null; parent = parent.getParent()) {
                if (AbstractC05254x.A08(parent, view, this.A04, i10, i11)) {
                    A01(i11, parent);
                    AbstractC05254x.A05(parent, view, this.A04, i10, i11);
                    return true;
                }
    ...
    public final boolean A0D(int i10, int i11, int startX, int startY, int[] iArr, int i12) {
        ...
        if (i10 != 0 || i11 != 0 || startX != 0 || startY != 0) {
            ...
            AbstractC05254x.A03(A00, view, i10, i11, startX, startY, i12);
            if (iArr != null) {
                this.A04.getLocationInWindow(iArr);
                iArr[0] = iArr[0] - i13;
    ...
    public final boolean A0F(int startX, int startY, int[] iArr, int[] iArr2, int i10) {
        ...
        if (startX != 0 || startY != 0) {
            ...
            consumed[0] = 0;
            consumed[1] = 0;
            AbstractC05254x.A04(parent, this.A04, startX, startY, consumed, i10);
            if (iArr2 != null) {
                this.A04.getLocationInWindow(iArr2);
                iArr2[0] = iArr2[0] - i11;
                iArr2[1] = iArr2[1] - i12;
