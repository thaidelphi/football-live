...
public abstract class AbstractC06409l {
    ...
    public static long A00(Context context) {
        return C06419m.A0U(context).A2t(A02(29, 25, 32), -1L);
    }

    public static long A01(Context context) {
        return C06419m.A0U(context).A2t(A02(131, 31, 31), -1L);
    }

    public static boolean A04(Context context) {
        return C06419m.A0U(context).A2y(A02(54, 39, 1), true);
    }

    public static boolean A05(Context context) {
        return C06419m.A0U(context).A2y(A02(0, 29, 97), false);
    }

    public static boolean A06(Context context) {
        return C06419m.A0U(context).A2y(A02(93, 16, 94), false);
    }

    public static boolean A07(Context context) {
        return C06419m.A0U(context).A2y(A02(109, 22, 37), false);
    }
}
