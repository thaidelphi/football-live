...
public abstract class OK<E> extends AbstractC1995lc<E> {
    ...
    public OK(int initialCapacity) {
        AbstractC1949ko.A00(initialCapacity, A00(0, 15, 58));
    ...
    private void A02(int minCapacity) {
        if (this.A02.length < minCapacity) {
            this.A02 = Arrays.copyOf(this.A02, AbstractC1995lc.A03(this.A02.length, minCapacity));
            this.A01 = false;
        } else if (!this.A01) {
        } else {
