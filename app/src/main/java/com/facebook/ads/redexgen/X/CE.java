    ...
    */
    public static int A05(org.xmlpull.v1.XmlPullParser r5) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        ...
        L23:
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.CE.A02
            r0 = 0
            r1 = r2[r0]
            r0 = 1
            r2 = r2[r0]
        ...
        L6a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.CE.A05(org.xmlpull.v1.XmlPullParser):int");
    }
    ...
    public static void A09(Context context) {
        ...
        A04 = CD.A03;
        Executors.newSingleThreadExecutor().execute(new C1795iI(context));
    }

    public static void A0A(AnonymousClass85 anonymousClass85, Throwable th) {
        anonymousClass85.A08().AAu(A06(38, 7, 85), AbstractC06048a.A1c, new C06058b(th));
    }
    ...
    public static boolean A0C(AnonymousClass85 anonymousClass85) {
        ...
        if (cachedValue != null) {
            ...
            boolean z10 = true;
            try {
                xmlResourceParser = anonymousClass85.getAssets().openXmlResourceParser(A06(0, 19, 21));
                loop0: while (true) {
