...
public abstract class AbstractC1961l1 {
    ...
    public static int A01(int expectedSize) {
        return Math.max(4, AbstractC1990lX.A01(expectedSize + 1, 1.0d));
    }
    ...
    public static int A06(@CheckForNull Object key, @CheckForNull Object value, @CheckForNull int mask, Object table, int[] entries, Object[] keys, Object[] values) {
        int tableIndex = AbstractC1990lX.A02(key);
        ...
        do {
            ...
            if (A02(tableIndex2, mask) == lastEntryIndex && AbstractC1013Or.A01(key, keys[entryIndex]) && (values == null || AbstractC1013Or.A01(value, values[entryIndex]))) {
