...
public final class C05776y implements NativeAdApi {
    ...
    public C05776y(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
        C1816ie.A0L(nativeAdBaseApi).A1b(EnumC0664Al.A06);
    }

    public C05776y(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
    }

    private C1816ie A00() {
        return C1816ie.A0L(this.A01);
    }
    ...
    public final List<NativeAd> A03() {
        ...
        for (C1816ie internalNativeAd : A00().A1I()) {
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, ImageView imageView, List<View> clickableViews) {
        if (imageView != null) {
            C1900k1 A12 = A00().A12();
            C1900k1 downloadContext = C05686p.A03(imageView.getContext());
            downloadContext.A0L(A12);
            C1816ie.A0k(A00().getAdIcon(), imageView, downloadContext);
        }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, MediaView mediaView2, List<View> list) {
        if (mediaView != null) {
            ((C1930kV) mediaView.getMediaViewApi()).A0L(this.A00);
        }
        if (mediaView2 != null) {
            ((C1930kV) mediaView2.getMediaViewApi()).A0M(this.A01, false);
        }
        if (list != null) {
