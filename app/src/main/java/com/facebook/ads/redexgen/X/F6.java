...
public class F6 extends WebViewClient {
    ...
    public F6(C1900k1 c1900k1, WeakReference<F4> weakReference, WeakReference<JL> weakReference2, WeakReference<C0710Cv> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C1697ge> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z10) {
        this.A02 = c1900k1;
    ...
    private WebResourceResponse A00() {
        return new WebResourceResponse(A01(286, 10, 123), StandardCharsets.UTF_8.name(), j3.a.b.f17898c, A01(13, 6, 1), Collections.singletonMap(A01(0, 13, 79), A01(268, 8, 74)), new ByteArrayInputStream(A01(13, 6, 1).getBytes()));
    }
    ...
    private void A03(int i10, CharSequence charSequence, long j10) {
        ...
        try {
            ...
            jSONObject.put(A01(j3.c.b.f17912c, 21, 122), z10);
            jSONObject.put(A01(223, 22, 100), j10);
            jSONObject.put(A01(276, 10, 90), this.A09.get());
        } catch (JSONException unused) {
        }
        this.A02.A08().AAu(A01(306, 8, 81), AbstractC06048a.A2f, new C06058b(AdErrorType.WEB_VIEW_FAILED_TO_LOAD.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
    }
    ...
    private void A07(String str, String str2) {
        ...
        if (this.A02 != null) {
            this.A02.A08().AAu(A01(306, 8, 81), AbstractC06048a.A2c, new C06058b(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x006c, code lost:
        r5 = com.facebook.ads.redexgen.X.C05987t.A09(r7.A02);
        r6 = A0A(r3, r5);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x0098, code lost:
        r4 = com.facebook.ads.redexgen.X.C1697ge.A0H;
        r0 = A01(108, 37, 87);
    ...
    */
    private boolean A08(android.net.Uri r8) {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.F6.A0C
            r0 = 3
            r1 = r2[r0]
            r0 = 6
            r0 = r2[r0]
        ...
        L52:
            ...
            r0.toString()
        L6c:
            com.facebook.ads.redexgen.X.k1 r0 = r7.A02
            java.util.List r5 = com.facebook.ads.redexgen.X.C05987t.A09(r0)
            ...
            r0.toString()
        L98:
            java.lang.String r4 = com.facebook.ads.redexgen.X.C1697ge.A03()
        ...
        Lbb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.F6.A08(android.net.Uri):boolean");
    }
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0F().AK5();
        this.A00 = new Date();
        new Handler().postDelayed(new C1698gf(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        boolean A11 = C06419m.A11(this.A02);
        String A01 = A01(0, 0, 53);
        if (A11 || webResourceRequest.isForMainFrame()) {
            this.A01 = true;
            A04(webResourceError.getErrorCode(), A01 + ((Object) webResourceError.getDescription()));
            return;
        }
        this.A02.A0F().AK6(CT.A01(webResourceError.getErrorCode(), A01 + ((Object) webResourceError.getDescription()), A01 + webResourceRequest.getUrl()));
    }
