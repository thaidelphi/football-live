...
public final class IC extends LinearLayout {
    ...
    public IC(C1900k1 c1900k1, NativeAd nativeAd, AW aw, C0772Ff c0772Ff, AdOptionsView adOptionsView) {
        super(c1900k1);
        setOrientation(0);
        ...
        addView(c0772Ff, iconViewParams);
        TextView textView = new TextView(c1900k1);
        aw.A08(textView);
        textView.setMaxLines(1);
        textView.setText(nativeAd.getAdvertiserName());
        TextView sponsoredTextView = new TextView(c1900k1);
