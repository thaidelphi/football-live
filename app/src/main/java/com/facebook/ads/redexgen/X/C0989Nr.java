...
public class C0989Nr<E> extends AbstractC2135nv<E> {
    public final /* synthetic */ Set A00;
    public final /* synthetic */ Set A01;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0989Nr(final Set val$set1, final Set val$set2) {
        super(null);
        this.A00 = val$set1;
        this.A01 = val$set2;
    }
    ...
    public final AbstractC2173oj<E> iterator() {
        return new On<E>() { // from class: com.facebook.ads.redexgen.X.2z
            ...
            {
                this.A00 = C0989Nr.this.A00.iterator();
            }
            ...
            public final E A02() {
                while (this.A00.hasNext()) {
                    ...
                    if (C0989Nr.this.A01.contains(next)) {
                        return next;
                    }
                }
                E e8 = A01();
