...
public final class C06479s implements InterfaceC1135Tn {
    ...
    public static Pair<Long, Long> A00(long j10, long[] jArr, long[] jArr2) {
        int A0L = AbstractC1672gE.A0L(jArr, j10, true, true);
        long j11 = jArr[A0L];
        long j12 = jArr2[A0L];
        int i10 = A0L + 1;
        if (i10 == jArr.length) {
    ...
    public C06479s(long[] jArr, long[] jArr2, long j10) {
        this.A01 = jArr;
        this.A02 = jArr2;
        this.A00 = j10 == -9223372036854775807L ? AbstractC1672gE.A0O(jArr2[jArr2.length - 1]) : j10;
    }

    public static C06479s A01(long j10, MlltFrame mlltFrame, long j11) {
        ...
        return new C06479s(jArr, jArr2, j11);
    }
    ...
    public final C1153Ui A8r(long j10) {
        Pair<Long, Long> A00 = A00(AbstractC1672gE.A0P(AbstractC1672gE.A0T(j10, 0L, this.A00)), this.A02, this.A01);
        return new C1153Ui(new C1154Uk(AbstractC1672gE.A0O(((Long) A00.first).longValue()), ((Long) A00.second).longValue()));
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC1135Tn
    public final long A97(long j10) {
        Pair<Long, Long> positionAndTimeMs = A00(j10, this.A01, this.A02);
        return AbstractC1672gE.A0O(((Long) positionAndTimeMs.second).longValue());
    }
