...
public abstract class AbstractC2064mj {
    ...
    public static int A00(@CheckForNull List<?> list, Object element) {
        ...
        while (listIterator.hasNext()) {
            if (AbstractC1013Or.A01(element, listIterator.next())) {
    ...
    public static int A01(@CheckForNull List<?> list, Object element) {
        ...
        while (listIterator.hasPrevious()) {
            if (AbstractC1013Or.A01(element, listIterator.previous())) {
    ...
    public static <E> ArrayList<E> A05(Iterator<? extends E> elements) {
        ...
        AbstractC2043mO.A0B(list, elements);
        return list;
    }

    public static boolean A06(@CheckForNull List<?> thisList, Object other) {
        if (other == AbstractC1790iD.A04(thisList)) {
            return true;
        }
        if (other instanceof List) {
            ...
            if (A00[7].charAt(4) != 'F') {
                ...
                if (z10 && (list instanceof RandomAccess)) {
                    for (int i10 = 0; i10 < size; i10++) {
                        if (!AbstractC1013Or.A01(thisList.get(i10), list.get(i10))) {
                            return false;
                        }
                    }
                    return true;
                }
                return AbstractC2043mO.A0G(thisList.iterator(), list.iterator());
            }
            throw new RuntimeException();
        }
        return false;
