...
public abstract class AbstractC0829Hk {
    ...
    public static BitmapDrawable A00(C1900k1 c1900k1, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c1900k1, overlayBm))) {
                ...
                Resources resources = c1900k1.getResources();
                if (resources != null) {
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    if (displayMetrics != null) {
                        overlayRepeat.setTargetDensity(displayMetrics.densityDpi);
                    } else {
                        A04(c1900k1, A02(0, 23, 41));
                    }
                } else {
                    A04(c1900k1, A02(23, 18, 119));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th) {
            c1900k1.A08().AAu(A02(59, 3, 58), AbstractC06048a.A1u, new C06058b(th));
            return null;
        }
    }

    public static C0830Hl A01(C1900k1 c1900k1, String str) {
        BitmapDrawable A002;
        try {
            if (TextUtils.isEmpty(str) || (A002 = A00(c1900k1, str)) == null) {
                return null;
            }
            C0830Hl c0830Hl = new C0830Hl(c1900k1);
            c0830Hl.setBackground(A002);
            c0830Hl.setClickable(false);
            c0830Hl.setFocusable(false);
            return c0830Hl;
        } catch (Throwable th) {
            c1900k1.A08().AAu(A02(59, 3, 58), AbstractC06048a.A1u, new C06058b(th));
            return null;
    ...
    public static void A04(C1900k1 c1900k1, String str) {
        c1900k1.A08().AAu(A02(59, 3, 58), AbstractC06048a.A1u, new C06058b(str));
    }
    ...
    */
    public static boolean A05(com.facebook.ads.redexgen.X.C1900k1 r4, android.graphics.Bitmap r5) {
        /*
            r3 = 0
        L1:
            int r0 = r5.getWidth()
        ...
        L36:
            r3 = 1
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.AbstractC0829Hk.A02
            r0 = 2
            r1 = r2[r0]
            r0 = 3
            r0 = r2[r0]
        ...
        L4f:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.AbstractC0829Hk.A05(com.facebook.ads.redexgen.X.k1, android.graphics.Bitmap):boolean");
    }
}
