...
public abstract class C2D<E> extends AbstractC0976Ne<E> implements List<E> {
    ...
    public static final C2134nu A02;
    ...
    public int lastIndexOf(E e8) {
        ...
        while (listIterator.hasPrevious()) {
            if (C2126nk.A0C(listIterator.previous(), e8)) {
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0976Ne, java.util.Collection, java.lang.Iterable, java.util.List
    public Iterator<E> iterator() {
        return new C0975Nd(this);
    }
    ...
    public ListIterator<E> listIterator(int i10) {
        return new C2Q(this, i10);
    }

    @Override // java.util.List
    public final List<E> subList(int i10, int i11) {
        return new C04050e(this, i10, i11);
    }
}
