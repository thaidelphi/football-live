...
/* renamed from: com.facebook.ads.redexgen.X.o1  reason: case insensitive filesystem */
/* loaded from: C:\Users\tewan\Downloads\Football Live HD\.\assets\audience_network.dex */
public enum EnumC2138o1 {
    A06,
    A04,
    A05;
    ...
    public static EnumC2138o1[] valuesCustom() {
        EnumC2138o1[] valuesCustom = values();
        if (A01[4].length() != 0) {
            A01[5] = "kC8OQjnUJR";
            return (EnumC2138o1[]) valuesCustom.clone();
        }
