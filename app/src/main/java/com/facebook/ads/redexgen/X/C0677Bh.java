...
public final class C0677Bh {
    public static C0677Bh A03;
    ...
    public final C0676Bg A01 = new C0676Bg();
    ...
    public C0677Bh(AnonymousClass85 anonymousClass85) {
        this.A00 = anonymousClass85;
    }

    public static C0677Bh A00(AnonymousClass85 anonymousClass85) {
        if (A03 == null) {
            A03 = new C0677Bh(anonymousClass85);
        }
        return A03;
    }
    ...
    private boolean A08(String str, String str2) {
        ...
        if (this.A02.get(str) != null) {
            ...
            if (maxLoadedAdsAllowed <= A0I && this.A02.get(str).contains(str2)) {
                return true;
            }
        }
        return false;
    ...
    public final int A0A(String str) {
        ...
        A05[3] = "fotbcTaHfC";
        return c0676Bg.A03(anonymousClass85, A01, 0);
    }
                ...
                try {
                    ...
                    if (!A08(str, clientToken)) {
                        ...
                        if (!jSONObject.has(A01)) {
                            continue;
                        } else if (System.currentTimeMillis() - jSONObject.getLong(A01) < C06419m.A02(this.A00)) {
    ...
    public final boolean A0F(String str) {
        return !C06419m.A18(this.A00) && (str.equals(AdPlacementType.BANNER.toString()) || str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString()));
    }
}
