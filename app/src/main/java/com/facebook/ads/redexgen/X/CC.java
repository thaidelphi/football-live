...
public abstract class CC {
    ...
    public static void A05(C1899k0 c1899k0, CZ cz, String str) {
        if (str == null || A03.contains(str)) {
            return;
        }
        boolean isPackageInstalled = A08(c1899k0.getPackageManager(), str);
        ...
        A02.postDelayed(new CB(new int[]{0}, str, c1899k0, cz), 1000L);
    }
    ...
    */
    public static void A06(com.facebook.ads.redexgen.X.C1899k0 r6, java.lang.String r7) {
        /*
            ...
            r5 = 49
            r3 = 22
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.CC.A01
            r0 = 1
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L4e:
            r2 = 0
            if (r0 == 0) goto L5c
            android.os.Handler r0 = com.facebook.ads.redexgen.X.CC.A02
            r0.removeCallbacksAndMessages(r2)
            java.util.Set<java.lang.String> r0 = com.facebook.ads.redexgen.X.CC.A03
            r0.remove(r7)
        L5b:
            return
        L5c:
            com.facebook.ads.redexgen.X.3O r1 = com.facebook.ads.redexgen.X.C3P.A00(r6)
            r0 = 5
            r1.A0A(r7, r2, r0)
            goto L5b
        L65:
            ...
            goto L4e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.CC.A06(com.facebook.ads.redexgen.X.k0, java.lang.String):void");
    }

    public static void A07(C1899k0 c1899k0, String str, CZ cz) {
        boolean isWithinFB = c1899k0.getPackageName().equals(A01(30, 19, 75)) || c1899k0.getPackageName().equals(A01(49, 22, 66));
        if (isWithinFB) {
            A05(c1899k0, cz, str);
        } else {
            C3P.A00(c1899k0).A0A(str, cz, 4);
        }
    }
