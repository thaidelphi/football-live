...
public class C1959ky<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public int A07(@CheckForNull Object key) {
        ...
        int A02 = AbstractC1990lX.A02(key);
        int A00 = A00();
        int A05 = AbstractC1961l1.A05(A0C(), A02 & A00);
        if (A05 == 0) {
            return -1;
        }
        int A022 = AbstractC1961l1.A02(A02, A00);
        do {
            int i10 = A05 - 1;
            int A01 = A01(i10);
            if (AbstractC1961l1.A02(A01, A00) == A022 && AbstractC1013Or.A01(key, A0E(i10))) {
                return i10;
            }
            A05 = AbstractC1961l1.A03(A01, A00);
        } while (A05 != 0);
        return -1;
    }
    ...
    public final Iterator<Map.Entry<K, V>> A0d() {
        Map<K, V> A0h = A0h();
        return A0h != null ? A0h.entrySet().iterator() : new OW(this);
    }
    ...
    public final Iterator<V> A0f() {
        Map<K, V> A0h = A0h();
        return A0h != null ? A0h.values().iterator() : new OV(this);
    }
    ...
    public void A0n(int dstIndex, int mask) {
        ...
        A0T[size] = 0;
        int A02 = AbstractC1990lX.A02(obj) & mask;
        int A05 = AbstractC1961l1.A05(A0C, A02);
        int i12 = size + 1;
        if (A05 == i12) {
            AbstractC1961l1.A0B(A0C, A02, dstIndex + 1);
            return;
        }
        do {
            i10 = A05 - 1;
            i11 = A0T[i10];
            A05 = AbstractC1961l1.A03(i11, mask);
        } while (A05 != i12);
        int A04 = AbstractC1961l1.A04(i11, dstIndex + 1, mask);
    ...
    public final V put(@ParametricNullness K key, @ParametricNullness V value) {
        ...
        int A00 = A00();
        int i14 = A02 & A00;
        int A05 = AbstractC1961l1.A05(A0C(), i14);
        if (A05 != 0) {
            int A022 = AbstractC1961l1.A02(A02, A00);
            int i15 = 0;
            do {
                i10 = A05 - 1;
                i11 = A0T[i10];
                if (AbstractC1961l1.A02(i11, A00) == A022 && AbstractC1013Or.A01(key, A0V[i10])) {
                    V v10 = (V) A0W[i10];
                    A0W[i10] = value;
                    A0k(i10);
                    return v10;
                }
                A05 = AbstractC1961l1.A03(i11, A00);
                i15++;
            } while (A05 != 0);
            if (i15 >= 9) {
            ...
            if (i13 > A00) {
                A00 = A02(A00, AbstractC1961l1.A00(A00), A02, i12);
            } else {
                A0T[i10] = AbstractC1961l1.A04(i11, i12 + 1, A00);
            }
        } else if (i13 <= A00) {
            AbstractC1961l1.A0B(A0C(), i14, i12 + 1);
            String[] strArr = A0A;
            if (strArr[0].length() != strArr[1].length()) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.ky != com.google.common.collect.CompactHashMap<K, V> */
    public C1959ky(int expectedSize) {
        A0l(expectedSize);
    }
    ...
    private int A02(int oldMask, int newCapacity, int targetHash, int targetEntryIndex) {
        Object A07 = AbstractC1961l1.A07(newCapacity);
        int hash = newCapacity - 1;
        if (targetEntryIndex != 0) {
            AbstractC1961l1.A0B(A07, targetHash & hash, targetEntryIndex + 1);
        }
        Object A0C = A0C();
        int[] A0T = A0T();
        for (int oldTableIndex = 0; oldTableIndex <= oldMask; oldTableIndex++) {
            int A05 = AbstractC1961l1.A05(A0C, oldTableIndex);
            while (A05 != 0) {
                int i10 = A05 - 1;
                int newMask = A0T[i10];
                int A02 = AbstractC1961l1.A02(newMask, oldMask) | oldTableIndex;
                int i11 = A02 & hash;
                int A052 = AbstractC1961l1.A05(A07, i11);
                AbstractC1961l1.A0B(A07, i11, A05);
                A0T[i10] = AbstractC1961l1.A04(A02, A052, hash);
                A05 = AbstractC1961l1.A03(newMask, oldMask);
            }
        }
        this.A05 = A07;
        A0O(hash);
    ...
    public static /* synthetic */ int A04(C1959ky c1959ky) {
        int i10 = c1959ky.A04;
        c1959ky.A04 = i10 - 1;
        return i10;
    }
    ...
    private final Set<Map.Entry<K, V>> A08() {
        return new C1955ku(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.ky != com.google.common.collect.CompactHashMap<K, V> */
    private final Set<K> A09() {
        return new C1957kw(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.ky != com.google.common.collect.CompactHashMap<K, V> */
    private final Collection<V> A0A() {
        return new C1958kx(this);
    }

    public static <K, V> C1959ky<K, V> A0B(int expectedSize) {
        return new C1959ky<>(expectedSize);
    }
    ...
    public Object A0K(@CheckForNull Object key) {
        ...
        int A00 = A00();
        int A06 = AbstractC1961l1.A06(key, null, A00, A0C(), A0T(), A0V(), null);
        if (A06 == -1) {
            Object obj = A0B;
            String[] strArr = A0A;
            String str = strArr[7];
    ...
    private void A0O(int mask) {
        int hashTableBits = AbstractC1961l1.A04(this.A03, 32 - Integer.numberOfLeadingZeros(mask), 31);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.ky != com.google.common.collect.CompactHashMap<K, V> */
    public int A0Z() {
        AbstractC1790iD.A0F(A0p(), A0L(0, 24, 121));
        int i10 = this.A03;
        int buckets = AbstractC1961l1.A01(i10);
        this.A05 = AbstractC1961l1.A07(buckets);
    ...
    public void A0l(int expectedSize) {
        AbstractC1790iD.A0E(expectedSize >= 0, A0L(24, 26, 16));
        this.A03 = AbstractC0985Nn.A02(expectedSize, 1, 1073741823);
    }
    ...
    public void A0o(@ParametricNullness int entryIndex, @ParametricNullness K key, V value, int hash, int mask) {
        A0P(entryIndex, AbstractC1961l1.A04(hash, 0, mask));
        A0Q(entryIndex, key);
    ...
    public void clear() {
        ...
        this.A03 = AbstractC0985Nn.A02(size(), 3, 1073741823);
        A0h.clear();
        this.A05 = null;
        this.A04 = 0;
    }
    ...
    public final boolean containsValue(@CheckForNull Object value) {
        ...
        for (int i10 = 0; i10 < this.A04; i10++) {
            if (AbstractC1013Or.A01(value, A0F(i10))) {
                return true;
            }
        }
        return false;
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException {
        ...
        while (true) {
            ...
            if (hasNext) {
                Map.Entry<K, V> e8 = A0d.next();
                stream.writeObject(e8.getKey());
                stream.writeObject(e8.getValue());
            } else {
                return;
            }
        }
