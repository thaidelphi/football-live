...
public final class D8 implements Executor {
    ...
    public static void A05(Context context) {
        A0D.set(C06419m.A2i(context));
        A0E.set(C06419m.A2h(context));
    }
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (D8.class) {
            ...
            if (size == reservedExecutorQueueSize) {
                ...
                C1899k0 A00 = AnonymousClass84.A00();
                if (A00 != null) {
                    A00.A08().AAu(A00(42, 7, 34), AbstractC06048a.A1d, new C06058b(A00(21, 21, 34), A00(14, 7, 32) + i10));
                }
            }
        }
