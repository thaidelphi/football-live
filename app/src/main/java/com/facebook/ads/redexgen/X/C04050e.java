...
public final class C04050e<E> extends C2D<E> implements RandomAccess {
    ...
    public C04050e(C2D<? extends E> c2d, int i10, int i11) {
        C2126nk.A09(c2d, A00(0, 4, 40));
        this.A02 = c2d;
        this.A01 = i10;
        C2D.A02.A05(this.A01, i11, this.A02.size());
