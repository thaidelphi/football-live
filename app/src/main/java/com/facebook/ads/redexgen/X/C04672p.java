...
public final class C04672p implements Serializable {
    public static byte[] A0J = null;
    public static final EnumC04682q A0K;
    ...
    public C04672p(String str, String str2, int i10, String str3, String str4, FF ff, int i11, boolean z10, boolean z11, EnumC04682q enumC04682q, boolean z12, String str5, boolean z13, boolean z14, int i12, String str6, String str7, boolean z15) {
        if (z12) {
    ...
    public static C04672p A01(JSONObject jSONObject) {
        JSONObject optJSONObject = jSONObject.optJSONObject(A03(255, 13, 26));
        if (optJSONObject == null) {
            return null;
        }
        EnumC04682q A00 = EnumC04682q.A00(optJSONObject.optString(A03(339, 17, 62), A0K.name()));
        String precachingMethodStr = A03(413, 30, 97);
        boolean optBoolean = optJSONObject.optBoolean(precachingMethodStr, false);
        String precachingMethodStr2 = A03(j3.a.b.f17905j, 3, 112);
        ...
        return new C04672p(optString, optString2, A002, A05, A04, A02, optInt, z10, optBoolean2, A00, optBoolean3, optString3, optBoolean, optBoolean4, optInt2, optString4, optString5, optJSONObject.optBoolean(precachingMethodStr9, false));
    }
