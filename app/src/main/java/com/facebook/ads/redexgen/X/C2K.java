...
public abstract class C2K {
     ...
     */
    public static C2063mi A01(C1900k1 c1900k1, JSONObject jSONObject, String str, boolean z10, int i10, int i11) {
        boolean optBoolean;
        int optInt;
        ArrayList arrayList;
        if (jSONObject == null) {
        ...
        String A02 = CV.A02(jSONObject, A02(266, 12, 52));
        Uri A002 = TextUtils.isEmpty(A02) ? null : C5.A00(A02);
        String A022 = CV.A02(jSONObject, A02(128, 4, 54));
        String A012 = AbstractC0702Cn.A01(A022);
        String A023 = CV.A02(jSONObject, A02(101, 15, 34));
        String A024 = CV.A02(jSONObject, A02(485, 5, 32));
        String A025 = CV.A02(jSONObject, A02(477, 8, 43));
        String A026 = CV.A02(jSONObject, A02(278, 8, 99));
        String A027 = CV.A02(jSONObject, A02(ActionSDK.ACTION_DIALOG, 14, 94));
        String A028 = CV.A02(jSONObject, A02(295, 16, 122));
        String A029 = CV.A02(jSONObject, A02(445, 21, 1));
        String A0210 = CV.A02(jSONObject, A02(87, 14, 99));
        String A0211 = CV.A02(jSONObject, A02(351, 20, 125));
        String A0212 = CV.A02(jSONObject, A02(335, 16, 114));
        String A0213 = CV.A02(jSONObject, A02(318, 17, 38));
        String A0214 = CV.A02(jSONObject, A02(132, 14, 16));
        C0967Mv A0215 = C0967Mv.A02(jSONObject, c1900k1);
        AU A003 = AU.A00(jSONObject.optJSONObject(A02(286, 4, 38)));
        AU A004 = AU.A00(jSONObject.optJSONObject(A02(290, 5, 12)));
        AV A005 = AV.A00(jSONObject.optJSONObject(A02(466, 11, 29)));
        String A0216 = CV.A02(jSONObject, A02(490, 15, 41));
        boolean optBoolean2 = jSONObject.optBoolean(A02(238, 15, 64));
        boolean optBoolean3 = jSONObject.optBoolean(A02(219, 19, 54));
        int optInt3 = jSONObject.optInt(A02(j3.a.b.f17901f, 25, 123), 4);
        ...
        AU A006 = optJSONObject != null ? AU.A00(optJSONObject) : null;
        String A0217 = CV.A02(jSONObject, A02(68, 19, 95));
        EnumC04491x A007 = AbstractC04511z.A00(jSONObject);
        Collection<String> A03 = AbstractC04511z.A03(c1900k1, jSONObject);
        String A0218 = CV.A02(jSONObject, A02(560, 9, 10));
        long optLong = jSONObject.optLong(A02(536, 24, 82), -1L);
        if (A01[2].charAt(6) != 'o') {
            String[] strArr = A01;
            strArr[1] = "3DgIwYJYxCZHaga7jdAdEfDBKsaQLEaY";
            strArr[0] = "PJjdxes2PDM40JhdCx";
            String A0219 = CV.A02(jSONObject, A02(IronSourceError.ERROR_NON_EXISTENT_INSTANCE, 9, 123));
            String A0220 = A02(IronSourceError.ERROR_CODE_KEY_NOT_SET, 22, 124);
            AZ az = !jSONObject.has(A0220) ? AZ.A03 : jSONObject.optBoolean(A0220) ? AZ.A05 : AZ.A04;
            ...
            try {
                ...
                if (optJSONArray != null && optJSONArray.length() > 0) {
                    ...
                    for (int i12 = 0; i12 < length; i12++) {
                        try {
                            arrayList2.add(A01(c1900k1, optJSONArray.getJSONObject(i12), str, true, i12, length));
                        } catch (JSONException e8) {
                            e = e8;
                            arrayList = arrayList2;
                            c1900k1.A08().AAu(A02(311, 7, 111), AbstractC06048a.A2A, new C06058b(e));
                            Log.e(C2076mv.A0E, A02(23, 30, 97), e);
                            return new C2063mi(A0217, A012, A022, A023, A024, A025, A026, A027, A028, A029, A0210, A0211, A0212, A0213, A0214, A006, A0215, A003, A004, A005, A0218, A0219, optLong, az, z10, i10, i11, arrayList, str, optString, optInt2, optString2, A002, A0216, optBoolean2, optBoolean3, optInt4, optInt3, optInt5, optInt6, A007, A03, optInt, optBoolean);
                        }
                    }
                    arrayList = arrayList2;
                }
    ...
    public static C2063mi A00(C1900k1 c1900k1, JSONObject jSONObject, String str) {
        return A01(c1900k1, jSONObject, str, false, -1, 0);
    }
}
