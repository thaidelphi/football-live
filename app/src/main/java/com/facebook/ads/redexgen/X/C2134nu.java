...
public final class C2134nu {
    ...
    public /* synthetic */ C2134nu(AbstractC2127nl abstractC2127nl) {
        this();
    }
    ...
    public final int A02(Collection<?> collection) {
        C2126nk.A09(collection, A00(31, 1, 39));
        int i10 = 1;
    ...
    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C2126nk.A09(collection, A00(31, 1, 39));
        C2126nk.A09(collection2, A00(50, 5, 95));
        ...
        while (it2.hasNext()) {
            if (!C2126nk.A0C(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
