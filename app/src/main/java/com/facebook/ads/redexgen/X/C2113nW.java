...
public final class C2113nW {
     ...
     */
    public final synchronized void A07() throws C2109nS {
        if (A09()) {
            return;
        }
        A06();
        ...
        if (!this.A00.renameTo(file)) {
            throw new C2109nS(A00(166, 20, 3) + this.A00 + A00(44, 4, 115) + file + A00(14, 16, 47));
        }
        this.A00 = file;
        try {
            this.A01 = new RandomAccessFile(this.A00, A00(256, 1, 61));
        } catch (IOException e8) {
            throw new C2109nS(A00(123, 14, 50) + this.A00 + A00(0, 14, 69), e8);
        }
    }

    public C2113nW(File file, C1O c1o) throws C2109nS {
        try {
            if (c1o != null) {
                this.A02 = c1o;
            ...
            throw new C2109nS(A00(186, 17, 54) + file + A00(0, 14, 69), e8);
        }
    }
    ...
    public final synchronized int A03() throws C2109nS {
        try {
        } catch (IOException e8) {
            throw new C2109nS(A00(137, 29, 78) + this.A00, e8);
        }
    ...
    public final synchronized void A05() throws C2109nS {
        try {
            this.A01.setLength(0L);
        } catch (IOException e8) {
            throw new C2109nS(A00(57, 16, 62), e8);
        }
    }

    public final synchronized void A06() throws C2109nS {
        try {
            this.A01.close();
            this.A02.AJW(this.A00);
        } catch (IOException e8) {
            throw new C2109nS(A00(104, 19, 93) + this.A00, e8);
        }
    }

    public final synchronized void A08(byte[] bArr, int i10) throws C2109nS {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i10);
            } else {
                throw new C2109nS(A00(73, 31, 71) + this.A00 + A00(30, 14, 126));
            }
        } catch (IOException e8) {
            throw new C2109nS(String.format(Locale.US, A00(j3.c.b.f17913d, 53, 72), Integer.valueOf(i10), this.A01, Integer.valueOf(bArr.length)), e8);
        }
    }
