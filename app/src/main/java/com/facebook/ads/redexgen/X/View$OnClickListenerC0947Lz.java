...
public final class View$OnClickListenerC0947Lz extends C1773hu implements View.OnClickListener, View.OnTouchListener {
    ...
    static {
        A09();
        A0B = 450;
        A09 = UnityAdsConstants.RequestPolicy.RETRY_WAIT_BASE;
        A0A = 50;
        A0D = 450;
        A0C = IronSourceConstants.REWARDED_VIDEO_DAILY_CAPPED;
    }

    public View$OnClickListenerC0947Lz(C05576e c05576e, C1900k1 c1900k1, A7 a72, DR dr, String str, int i10) {
        super(c05576e, c1900k1, a72, dr);
        this.A00 = 0;
        this.A01 = 0;
        this.A03 = false;
        ...
        this.A06 = (InputMethodManager) c1900k1.getSystemService(A05(112, 12, 70));
        this.A04 = i10;
    }

    public static /* synthetic */ int A02(View$OnClickListenerC0947Lz view$OnClickListenerC0947Lz) {
        int i10 = view$OnClickListenerC0947Lz.A00;
        view$OnClickListenerC0947Lz.A00 = i10 + 1;
        return i10;
    }
    ...
    @Override // com.facebook.ads.redexgen.X.C1773hu
    public final InterfaceC0762Ev A0E() {
        return new C1777hy(this);
    }
    ...
    public final void A0F() {
        ...
        this.A0B.setOnTouchListener(new View.OnTouchListener() { // from class: com.facebook.ads.redexgen.X.DT
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return View$OnClickListenerC0947Lz.A0B(view, motionEvent);
            }
        });
    ...
    public final void A0H(String str) {
        if (this.A04 > 0 && !this.A03) {
            ...
            if (this.A02 != null) {
                this.A02.A04(AE.A0J, A05);
            }
            A07();
            this.A09.AB3(super.A04, A05);
            if (C06419m.A2L(super.A08)) {
                ...
                this.A09.ABC(super.A04, hashMap);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.X.C1773hu, com.facebook.ads.redexgen.X.DS
    public final void AAj(Intent intent, Bundle bundle, C05576e c05576e) {
        super.AAj(intent, bundle, c05576e);
