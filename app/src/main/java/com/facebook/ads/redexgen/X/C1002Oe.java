...
public class C1002Oe<K, V> extends AbstractC2082n1<K, Collection<V>> {
    ...
    public C1002Oe(final C4U this$0, Map<K, Collection<V>> submap) {
        this.A01 = this$0;
        this.A00 = submap;
    }
    ...
    public final Collection<V> get(@CheckForNull Object key) {
        Collection<V> collection = (Collection) AbstractC2083n2.A05(this.A00, key);
        if (collection == null) {
            return null;
        }
    ...
    public final Collection<V> remove(@CheckForNull Object key) {
        ...
        A0D.addAll(remove);
        C4U.A03(this.A01, remove.size());
        remove.clear();
        return A0D;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Oe != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap */
    @Override // com.facebook.ads.redexgen.X.AbstractC2082n1
    public final Set<Map.Entry<K, Collection<V>>> A09() {
        return new O2<K, Collection<V>>() { // from class: com.facebook.ads.redexgen.X.4Y
            ...
            public final boolean contains(@CheckForNull Object o10) {
                return AbstractC1954kt.A03(C1002Oe.this.A00.entrySet(), o10);
            }

            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.4Y != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap$AsMapEntries */
            @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
            public final Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return new C1853jG(C1002Oe.this);
            }
            ...
            public final boolean remove(@CheckForNull Object o10) {
                ...
                C1002Oe c1002Oe = C1002Oe.this;
                if (A01[2].length() != 19) {
                    A01[3] = "G2qcJwlII5HIikaXRsYLysr3qmkTj7oM";
                    c1002Oe.A01.A0A(entry.getKey());
                    return true;
                }
    ...
    public final Map.Entry<K, Collection<V>> A0A(Map.Entry<K, Collection<V>> entry) {
        K key = entry.getKey();
        return AbstractC2083n2.A01(key, this.A01.A0F(key, entry.getValue()));
    }
    ...
    public final void clear() {
        ...
        if (map2 == map) {
            ...
            AbstractC2043mO.A0A(new C1853jG(this));
        }
    }
    ...
    public final boolean containsKey(@CheckForNull Object key) {
        return AbstractC2083n2.A0C(this.A00, key);
    }
