...
public enum EnumC0664Al {
    ...
    A0I(103),
    A06(200),
    A05(UnityAdsConstants.RequestPolicy.RETRY_WAIT_BASE),
    A0A(800),
    A09(801),
    A0B(802),
    A0C(803),
    A04(j3.c.b.f17911b),
    A07(CommonGatewayClient.CODE_400);
    ...
    public static EnumC0664Al A00(int i10) {
        EnumC0664Al[] values;
        for (EnumC0664Al enumC0664Al : values()) {
            if (enumC0664Al.A00 == i10) {
                return enumC0664Al;
            }
        }
        return null;
    ...
    public final AdPlacementType A05(AnonymousClass85 anonymousClass85) {
        switch (this) {
            ...
            case A0D:
                boolean A18 = C06419m.A18(anonymousClass85);
                String[] strArr = A02;
