...
public final class DX extends AdNativeComponentView {
    ...
    public static final int A09 = ((int) CP.A02) * UnityAdsConstants.RequestPolicy.RETRY_WAIT_BASE;
    ...
    public static final int A0A = (int) (CP.A02 * 0.5d);

    public DX(C1900k1 c1900k1, AW aw) {
        super(c1900k1);
        this.A06 = aw;
        this.A05 = new TextView(c1900k1);
        this.A04 = new TextView(c1900k1);
        this.A03 = new TextView(c1900k1);
        this.A02 = new RelativeLayout(c1900k1);
        this.A00 = new LinearLayout(c1900k1);
        this.A01 = new RelativeLayout(c1900k1);
        this.A07 = new C1739hK(c1900k1);
        A09();
        A0D();
        A05();
        A0A();
    ...
    public final void onMeasure(int i10, int i11) {
        int A0F2 = ((int) CP.A02) * C06419m.A0F(getContext());
