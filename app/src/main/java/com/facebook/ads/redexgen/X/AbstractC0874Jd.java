...
public abstract class AbstractC0874Jd {
    ...
    public AbstractC0874Jd(String str, C0876Jf c0876Jf, JZ jz) {
        this.A03 = A00(0, 0, 34);
        if (str != null) {
            this.A03 = str;
        }
        if (c0876Jf != null && !c0876Jf.A06().isEmpty()) {
            this.A03 += A00(0, 1, 55) + c0876Jf.A06();
        }
        this.A00 = jz;
    }
