...
public final class C05786z implements NativeAdScrollViewApi {
    ...
    public C05786z(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i10, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i11) {
        if (nativeAdsManager.isLoaded()) {
            if (type != null || adViewProvider != null || i10 > 0) {
                this.A06 = C05686p.A03(context);
                this.A04 = nativeAdsManager;
                this.A03 = nativeAdViewAttributes;
                this.A01 = adViewProvider;
                this.A02 = type;
                this.A00 = i11;
                C1928kT c1928kT = new C1928kT(this);
                this.A05 = new C1927kS(context);
                if (this.A02 == null) {
                    if (i10 > 0) {
                        this.A05.A00(((int) CP.A02) * i10);
                    }
                } else {
                    this.A05.A00((int) (CP.A02 * this.A02.getHeight()));
                }
                this.A05.setAdapter(c1928kT);
                setInset(20);
                c1928kT.A09();
