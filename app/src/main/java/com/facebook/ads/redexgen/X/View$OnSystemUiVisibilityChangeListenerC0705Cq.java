...
public final class View$OnSystemUiVisibilityChangeListenerC0705Cq implements View.OnSystemUiVisibilityChangeListener {
    ...
    public EnumC0704Cp A02 = EnumC0704Cp.A02;
    public final Runnable A04 = new C1784i6(this);

    public View$OnSystemUiVisibilityChangeListenerC0705Cq(View view) {
        this.A03 = view;
    ...
    public void A02(boolean z10) {
        if (EnumC0704Cp.A02.equals(this.A02)) {
            return;
        }
        int i10 = 3840;
        if (!z10) {
    ...
    public final void A05(EnumC0704Cp enumC0704Cp) {
        this.A02 = enumC0704Cp;
        switch (this.A02) {
            case A03:
                A00(67108864, true);
                A00(134217728, true);
