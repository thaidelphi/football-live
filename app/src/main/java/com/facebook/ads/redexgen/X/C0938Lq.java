...
public final class C0938Lq {
    ...
    public /* synthetic */ C0938Lq(AbstractC2127nl abstractC2127nl) {
        this();
    }
    ...
    private final long A01(List<C0940Ls> list, int i10, int i11) {
        HashMap hashMap = new HashMap();
        int i12 = i10 + i11;
        for (int i13 = i10 + 1; i13 < i12; i13++) {
            long A03 = list.get(i13).A03();
            long A012 = list.get(i13).A01();
            Long valueOf = Long.valueOf(A03);
            Long valueOf2 = Long.valueOf(A03);
            int i14 = hashMap.get(valueOf2);
            if (i14 == null) {
                i14 = 0;
                hashMap.put(valueOf2, 0);
            }
            hashMap.put(valueOf, Integer.valueOf(((Number) i14).intValue() + 1));
            Long valueOf3 = Long.valueOf(A012);
            Long valueOf4 = Long.valueOf(A012);
            int i15 = hashMap.get(valueOf4);
            if (i15 == null) {
                i15 = 0;
                hashMap.put(valueOf4, 0);
            }
            hashMap.put(valueOf3, Integer.valueOf(((Number) i15).intValue() + 1));
        }
        long j10 = 3333;
        int baseCountCurr = 0;
        ...
        int i16 = i10 + i11;
        for (int i17 = i10 + 1; i17 < i16; i17++) {
            list.get(i17).A09(list.get(i17).A03() - j10);
            list.get(i17).A07(list.get(i17).A01() - j10);
        }
        return j10;
    }
    ...
    private final String A03(String str) {
        ...
        if (length > 0) {
            while (length < 3) {
                p10.append(com.ironsource.cc.T);
                sb.append((char) 0);
                length++;
            }
        }
    ...
    private final String A04(List<Long> list) {
        ...
        for (Long l10 : list) {
            A08(sb, A00(l10.longValue()));
        }
        String sb2 = sb.toString();
        C2126nk.A08(sb2, A02(115, 13, 74));
        return A03(sb2);
    }

    private final String A05(List<C0940Ls> list, int i10, int i11, boolean z10) {
        ...
        if (i11 > 1) {
            ...
            for (int i13 = i10 + 1; i13 < i12; i13++) {
                ...
                if (z10) {
                    framesTimestampList.add(Long.valueOf(list.get(i13).A04()));
                    if (list.get(i13).A04() != 0) {
                        z12 = true;
                    }
                }
            }
    ...
    private final String A06(Map<String, ? extends Object> map) {
        ...
        C2126nk.A08(jSONObject, A02(115, 13, 74));
        return jSONObject;
    }
    ...
    private final void A08(StringBuilder sb, long j10) {
        while (j10 >= 128) {
            long v10 = 128;
            j10 >>= 7;
            sb.append((char) (AbstractC2140o3.A00((short) (((128 - 1) & j10) | v10)) & 65535));
        }
        int A002 = AbstractC2140o3.A00((short) j10) & 65535;
        String[] strArr = A01;
    ...
    private final void A09(List<C0940Ls> list, int i10, int i11) {
        long A002;
        int i12 = (i10 + i11) - 1;
        int i13 = i10 + 1;
        if (i13 > i12) {
        ...
        while (true) {
            int i14 = i12 - 1;
            list.get(i12).A09(list.get(i12).A03() - list.get(i14).A03());
            int i15 = i12 - 1;
            list.get(i12).A07(list.get(i12).A01() - list.get(i15).A01());
            int i16 = i12 - 1;
            list.get(i12).A08(list.get(i12).A02() - list.get(i16).A02());
            C0940Ls c0940Ls = list.get(i12);
            int i17 = i12 - 1;
            long j10 = 0;
            if (list.get(i17).A00() == -1) {
                ...
                int i18 = i12 - 1;
                A002 = list.get(i12).A00() - list.get(i18).A00();
            }
            c0940Ls.A06(A002);
            C0940Ls c0940Ls2 = list.get(i12);
            int i19 = i12 - 1;
            if (list.get(i19).A04() != -1) {
                int i20 = i12 - 1;
                j10 = list.get(i12).A04() - list.get(i20).A04();
            }
            c0940Ls2.A0A(j10);
    ...
    @JvmStatic
    public final String A0A(List<C0940Ls> list) {
        if (list == null) {
            String[] strArr = A01;
