...
public abstract class AbstractC0976Ne<E> implements Collection<E> {
    ...
    public boolean contains(E e8) {
        AbstractC0976Ne<E> abstractC0976Ne = this;
        if ((abstractC0976Ne instanceof Collection) && abstractC0976Ne.isEmpty()) {
            return false;
        }
        for (E e10 : abstractC0976Ne) {
            if (C2126nk.A0C(e10, e8)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean containsAll(Collection<? extends Object> collection) {
        C2126nk.A09(collection, A08(60, 8, 90));
    ...
    public Object[] toArray() {
        return AbstractC2128nm.A02(this);
    }

    @Override // java.util.Collection
    public <T> T[] toArray(T[] tArr) {
        C2126nk.A09(tArr, A08(55, 5, 15));
        return (T[]) AbstractC2128nm.A03(this, tArr);
    }

    public final String toString() {
        return AnonymousClass05.A03(this, A08(0, 2, 33), A08(53, 1, 93), A08(54, 1, 109), 0, null, new C04060f(this), 24, null);
    }
}
