...
public final class C06359g implements Closeable {
    ...
    public final Deque<C06349f> A02 = new LinkedList();
    ...
    public C06359g(C9W c9w, InterfaceC06339e interfaceC06339e) throws IOException {
        this.A01 = c9w;
        A05(c9w, interfaceC06339e);
        if (this.A02.isEmpty()) {
            A00();
        }
    }

    private C06349f A00() throws IOException {
        int i10 = -1;
        if (!this.A02.isEmpty()) {
            i10 = this.A02.getLast().A00();
        }
        int i11 = i10 + 1;
        this.A02.add(new C06349f(i11, new C06319c(new File(this.A01.A05(), A01(i11)))));
    ...
    private void A04(int i10, File file) throws IOException {
        C06319c c06319c = new C06319c(file);
        c06319c.A05();
        this.A02.addFirst(new C06349f(i10, c06319c));
    }

    private void A05(C9W c9w, InterfaceC06339e interfaceC06339e) throws IOException {
        ...
        if (listFiles != null) {
            ...
            for (File file : listFiles) {
                try {
                    ...
                    hashSet.add(file);
                    interfaceC06339e.AHi(String.format(Locale.US, A02(260, 39, 118), file.getCanonicalPath()));
                }
            }
            ...
            if (!isEmpty) {
                ...
                while (it.hasNext()) {
                    ...
                    if (intValue < i11) {
                        interfaceC06339e.AHi(String.format(Locale.US, A02(166, 61, 41), Integer.valueOf(intValue), Integer.valueOf(i11)));
                ...
                while (i10 >= i11) {
                    ...
                    try {
                        ...
                        interfaceC06339e.AHj(String.format(Locale.US, A02(104, 62, 55), file2.getCanonicalPath(), Integer.valueOf(i10)), e8);
            ...
            for (Object obj : hashSet) {
                ...
                if (!file3.delete()) {
                    ...
                    if (A04[7].charAt(19) != 'm') {
                        ...
                        interfaceC06339e.AHi(String.format(locale, A02(40, 26, 116), objArr));
                    } else {
                        A04[7] = "xgRJlHLuW2qx7z7dN03x9GIdgxBOKXSD";
                        objArr[0] = canonicalPath;
                        interfaceC06339e.AHi(String.format(locale, A02(38, 20, 82), objArr));
                    }
                }
            }
            return;
        }
        IOException e10 = new IOException(String.format(Locale.US, A02(66, 38, 13), c9w.A05().getCanonicalPath()));
        throw e10;
    }
    ...
    public final synchronized C9U A0A(int i10, int i11, byte[] bArr, int i12, int[] iArr, int i13) throws IOException {
        if (!this.A00) {
            for (C06349f file : this.A02) {
                if (file.A00() == i10) {
                    return new C9U(i10, file.A02(i11, bArr, i12, iArr, i13));
                }
            }
