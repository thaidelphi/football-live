...
public final class C2065mk extends AnonymousClass25 {
    ...
    public AX A05;
    public String A06;
    public WeakReference<C1946kl> A07;
    ...
    public C2065mk(C1900k1 c1900k1, AnonymousClass26 anonymousClass26, JL jl, C2076mv c2076mv) {
    ...
    private JSONObject A04(View view) throws JSONException {
        ...
        boolean z10 = false;
        jSONObject.putOpt(A01(129, 6, 114), String.format(Locale.US, A01(j3.c.b.f17915f, 12, 61), Integer.valueOf(view.getTop()), Integer.valueOf(view.getLeft())));
    ...
    private void A07(Map<String, String> map) {
        if (this.A02 != null && (this.A02.getNativeAdLayoutApi() instanceof C1929kU)) {
            C1929kU c1929kU = (C1929kU) this.A02.getNativeAdLayoutApi();
            if (c1929kU.A05()) {
                map.put(A01(87, 7, 108), Boolean.TRUE.toString());
            }
            boolean A04 = c1929kU.A04();
            if (A0H[2].charAt(5) == '8') {
                throw new RuntimeException();
            }
            String[] strArr = A0H;
    ...
    public final void A08(Map<String, String> map) {
        ...
        if (this.A01 != null) {
            ...
            map.put(A01(94, 4, 124), String.valueOf((int) (this.A01.getHeight() / CP.A02)));
        }
        if (this.A04 != null) {
    ...
    public final void A0G(WeakReference<C1946kl> weakReference) {
