...
public class C1420c8 {
     ...
     */
    public C1420c8(C1900k1 c1900k1, A7 a72, IF r14, String str, boolean z10, int i10, int i11, boolean z11, Bundle bundle, Map<String, String> map, IN in) {
        this.A02 = 0;
        this.A01 = 0;
        this.A05 = false;
        this.A0B = false;
        ...
        arrayList.add(new C1422cA(this, 0.5d, -1.0d, 2.0d, true));
        arrayList.add(new C1421c9(this, 1.0E-7d, -1.0d, 0.001d, false));
        if (bundle != null) {
            this.A0C = new C1997le(arrayList, bundle.getBundle(A0H(6, 16, 57)), this.A0G);
            ...
            this.A02 = i10;
            this.A01 = i11;
            this.A0C = new C1997le(arrayList, this.A0G);
        }
        this.A05 = C06419m.A2N(this.A0D);
        this.A0B = C06419m.A2R(this.A0D);
    ...
    public Map<String, String> A0J(IH ih) {
        ...
        int i10 = this.A00 + 1;
        this.A00 = i10;
        return A0K(ih, currentPositionInMillis, i10);
    }

    private Map<String, String> A0K(IH ih, int i10, int i11) {
        HashMap hashMap = new HashMap();
        D0.A03(hashMap, this.A0F.getVideoStartReason() == IP.A02, !this.A0F.AAK());
        A0U(hashMap);
        A0S(hashMap);
        A0W(hashMap, i10);
        A0V(hashMap);
        A0T(hashMap);
        A0n(ih, hashMap);
        hashMap.put(A0H(0, 6, 24), String.valueOf(ih.A00));
    ...
    private final void A0P(int i10, boolean z10, boolean z11) {
        ...
        if (i10 > this.A02) {
            ...
            double A9L = this.A0G.A9L();
            if (A9L < 0.5d && C06419m.A1b(this.A0D)) {
                this.A0D.A0F().AJp(String.valueOf(A9L));
            }
            this.A02 = i10;
    ...
    private void A0S(Map<String, String> params) {
        ...
        params.put(A0H(j3.c.b.f17911b, 5, 61), String.valueOf(A01.A03()));
    ...
    private void A0V(Map<String, String> params) {
        ...
        params.put(A0H(j3.c.b.f17916g, 3, 4), String.valueOf(displayMetrics.heightPixels));
    ...
    public final void A0o(C1420c8 c1420c8) {
        c1420c8.A06 = this.A06;
        c1420c8.A07 = this.A07;
        c1420c8.A0A = this.A0A;
        c1420c8.A09 = this.A09;
        c1420c8.A02 = this.A02;
        c1420c8.A01 = this.A01;
    }
}
