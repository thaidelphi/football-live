...
public final class C04993v extends Drawable {
    ...
    public C04993v(ColorStateList colorStateList, float f10) {
        this.A01 = f10;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float A01 = AbstractC05013x.A01(this.A00, this.A01, this.A07);
            float vInset = AbstractC05013x.A00(this.A00, this.A01, this.A07);
