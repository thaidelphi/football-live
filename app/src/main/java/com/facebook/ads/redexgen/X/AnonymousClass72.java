...
public final class AnonymousClass72 implements NativeAdsManagerApi {
    ...
    public AnonymousClass72(Context context, String str, int i10) {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        EnumC0664Al enumC0664Al = EnumC0664Al.A06;
        int i10 = this.A06;
        C2030mB c2030mB = this.A02;
        this.A02 = new C2030mB(this.A07, this.A08, enumC0664Al, null, i10);
        if (this.A05) {
            this.A02.A06();
        }
        this.A02.A09(this.A03);
        this.A02.A08(new C1923kO(this, this.A07, mediaCacheFlag));
        this.A02.A07();
    }
    ...
    public final NativeAd nextNativeAd(NativeAdListener nativeAdListener) {
        ...
        if (nativeAdListener != null) {
            ((C1816ie) nativeAd.getInternalNativeAd()).A1U(nativeAd, nativeAdListener);
        }
