...
import com.facebook.ads.redexgen.X.AbstractC06048a;
import com.facebook.ads.redexgen.X.Br;
import com.facebook.ads.redexgen.X.Bs;
import com.facebook.ads.redexgen.X.C06058b;
import com.facebook.ads.redexgen.X.C06419m;
import com.facebook.ads.redexgen.X.C0685Bw;
import com.facebook.ads.redexgen.X.C1899k0;
import com.facebook.ads.redexgen.X.C1900k1;
import com.facebook.ads.redexgen.X.ExecutorC0712Cx;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
    ...
    public static final C0685Bw A05;
     ...
     */
    public static synchronized void A04(C1899k0 c1899k0, Class<? extends Activity> cls) {
        synchronized (ActivityUtils.class) {
            A02 = c1899k0;
            A01 = c1899k0.getApplicationContext();
                ...
                if (aNActivityLifecycleCallbacksListener != null) {
                    ...
                    synchronized (activityStateMap) {
                        try {
                            ...
                            c1899k0.A08().AAu(A01(208, 8, 61), AbstractC06048a.A02, new C06058b(A01(72, 80, 65)));
                        }
                    }
                    ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c1899k0);
                }
                ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
            } else {
                c1899k0.A08().AAu(A01(216, 3, 3), AbstractC06048a.A0d, new C06058b(A01(42, 30, 126)));
            }
        }
    }
    ...
    */
    public static synchronized android.app.Activity A00() {
        ...
        L3b:
            if (r1 == 0) goto L41
            android.app.Activity r5 = com.facebook.ads.redexgen.X.AbstractC0682Bp.A00()     // Catch: java.lang.Throwable -> La0
        L41:
            com.facebook.ads.redexgen.X.k0 r0 = com.facebook.ads.internal.util.activity.ActivityUtils.A02     // Catch: java.lang.Throwable -> La0
            if (r0 == 0) goto L9a
            if (r1 == 0) goto L9a
            if (r6 == r5) goto L9a
            r2 = 19
            ...
            com.facebook.ads.redexgen.X.8b r2 = new com.facebook.ads.redexgen.X.8b     // Catch: java.lang.Throwable -> La0
            r2.<init>(r1, r0)     // Catch: java.lang.Throwable -> La0
            r2.A05(r7)     // Catch: java.lang.Throwable -> La0
            com.facebook.ads.redexgen.X.k0 r0 = com.facebook.ads.internal.util.activity.ActivityUtils.A02     // Catch: java.lang.Throwable -> La0
            com.facebook.ads.redexgen.X.8Z r4 = r0.A08()     // Catch: java.lang.Throwable -> La0
            r3 = 208(0xd0, float:2.91E-43)
            r1 = 8
            r0 = 61
            java.lang.String r0 = A01(r3, r1, r0)     // Catch: java.lang.Throwable -> La0
            int r1 = com.facebook.ads.redexgen.X.AbstractC06048a.A03     // Catch: java.lang.Throwable -> La0
            r4.AAu(r0, r1, r2)     // Catch: java.lang.Throwable -> La0
        L9a:
            if (r6 == 0) goto L9e
            monitor-exit(r8)
            return r6
    ...
    public static void A03(C1900k1 c1900k1) {
        if (!C06419m.A1i(c1900k1) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        Br br = new Br(c1900k1);
        synchronized (A07) {
            A07.add(br);
        }
        ExecutorC0712Cx.A01.A01().postDelayed(br, 2000L);
    }
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (num == null || num.intValue() != 3) {
            C06058b c06058b = new C06058b(A01(172, 31, 79), A01(152, 20, 101) + num + A01(0, 12, 105) + activity);
            c06058b.A05(0);
            A02.A08().AAu(A01(208, 8, 61), AbstractC06048a.A03, c06058b);
        }
        A08.put(activity, 4);
        if (activity.getClass() != this.A00) {
            ...
            while (it.hasNext()) {
                ExecutorC0712Cx.A01.A01().removeCallbacks((Runnable) it.next());
            }
        }
        A05.A01();
    }
