...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final androidx.collection.a<String, Integer> f643c;

    /* renamed from: d  reason: collision with root package name */
    private static final String[] f644d;

    /* renamed from: e  reason: collision with root package name */
    private static final String[] f645e;

    /* renamed from: f  reason: collision with root package name */
    private static final String[] f646f;

    /* renamed from: a  reason: collision with root package name */
    final Bundle f647a;

    /* renamed from: b  reason: collision with root package name */
    private MediaMetadata f648b;
    ...
    static {
        ...
        f644d = new String[]{"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};
        f645e = new String[]{"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};
        f646f = new String[]{"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};
        CREATOR = new a();
    }

    MediaMetadataCompat(Parcel parcel) {
        this.f647a = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
    ...
    public static MediaMetadataCompat a(Object obj) {
        ...
        obtain.recycle();
        createFromParcel.f648b = mediaMetadata;
