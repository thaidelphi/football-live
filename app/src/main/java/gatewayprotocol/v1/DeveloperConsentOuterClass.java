...
public final class DeveloperConsentOuterClass {
    ...
    public static final class DeveloperConsent extends GeneratedMessageLite<DeveloperConsent, Builder> implements DeveloperConsentOrBuilder {
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (a.f26114a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    public enum DeveloperConsentChoice implements Internal.EnumLite {
        ...
        /* loaded from: C:\Users\tewan\Downloads\Football Live HD\.\classes3.dex */
        class a implements Internal.EnumLiteMap<DeveloperConsentChoice> {
            a() {
            }
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            static final Internal.EnumVerifier f26112a = new b();
    ...
    public enum DeveloperConsentType implements Internal.EnumLite {
        ...
        /* loaded from: C:\Users\tewan\Downloads\Football Live HD\.\classes3.dex */
        class a implements Internal.EnumLiteMap<DeveloperConsentType> {
            a() {
            }
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            /* renamed from: a  reason: collision with root package name */
            static final Internal.EnumVerifier f26113a = new b();
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f26114a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f26114a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f26114a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f26114a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f26114a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f26114a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
