...
public final class InitializationResponseOuterClass {
    ...
    public enum AdFormat implements Internal.EnumLite {
        ...
        /* loaded from: C:\Users\tewan\Downloads\Football Live HD\.\classes3.dex */
        class a implements Internal.EnumLiteMap<AdFormat> {
            a() {
            }
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            static final Internal.EnumVerifier f26131a = new b();
    ...
    public static final class InitializationResponse extends GeneratedMessageLite<InitializationResponse, Builder> implements InitializationResponseOrBuilder {
        ...
        private static final Internal.ListAdapter.Converter<Integer, AdFormat> scarEligibleFormats_converter_ = new a();
        ...
        /* loaded from: C:\Users\tewan\Downloads\Football Live HD\.\classes3.dex */
        class a implements Internal.ListAdapter.Converter<Integer, AdFormat> {
            a() {
            }
        ...
        private static final class b {
            ...
            /* renamed from: a  reason: collision with root package name */
            static final MapEntryLite<String, Placement> f26132a = MapEntryLite.newDefaultInstance(WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Placement.getDefaultInstance());
        }
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (a.f26133a[methodToInvoke.ordinal()]) {
                case 1:
                    return new InitializationResponse();
                case 2:
                    return new Builder(null);
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0007\u0000\u0001\u0001\u0007\u0007\u0001\u0001\u0000\u0001\t\u0002ለ\u0000\u0003ဉ\u0001\u0004\u0007\u0005\u0004\u00062\u0007,", new Object[]{"bitField0_", "nativeConfiguration_", "universalRequestUrl_", "error_", "triggerInitializationCompletedRequest_", "countOfLastShownCampaigns_", "scarPlacements_", b.f26132a, "scarEligibleFormats_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f26133a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f26133a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f26133a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f26133a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f26133a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f26133a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
