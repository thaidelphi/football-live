...
public class b0 extends Fragment {
    ...
    public static final class b {
        ...
        public final void a(Activity activity, i.a event) {
            ...
            if (activity instanceof s) {
                ((s) activity).getLifecycle().i(event);
    ...
    public static final class c implements Application.ActivityLifecycleCallbacks {
        ...
        public void onActivityPostCreated(Activity activity, Bundle bundle) {
            kotlin.jvm.internal.n.f(activity, "activity");
            b0.f3607b.a(activity, i.a.ON_CREATE);
        }

        @Override // android.app.Application.ActivityLifecycleCallbacks
        public void onActivityPostResumed(Activity activity) {
            kotlin.jvm.internal.n.f(activity, "activity");
            b0.f3607b.a(activity, i.a.ON_RESUME);
        }

        @Override // android.app.Application.ActivityLifecycleCallbacks
        public void onActivityPostStarted(Activity activity) {
            kotlin.jvm.internal.n.f(activity, "activity");
            b0.f3607b.a(activity, i.a.ON_START);
        }

        @Override // android.app.Application.ActivityLifecycleCallbacks
        public void onActivityPreDestroyed(Activity activity) {
            kotlin.jvm.internal.n.f(activity, "activity");
            b0.f3607b.a(activity, i.a.ON_DESTROY);
        }

        @Override // android.app.Application.ActivityLifecycleCallbacks
        public void onActivityPrePaused(Activity activity) {
            kotlin.jvm.internal.n.f(activity, "activity");
            b0.f3607b.a(activity, i.a.ON_PAUSE);
        }

        @Override // android.app.Application.ActivityLifecycleCallbacks
        public void onActivityPreStopped(Activity activity) {
            kotlin.jvm.internal.n.f(activity, "activity");
            b0.f3607b.a(activity, i.a.ON_STOP);
        }
