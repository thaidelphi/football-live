...
public final class j {
    ...
    private static class f implements ActionMode.Callback {
        ...
        private final ActionMode.Callback f3026a;

        /* renamed from: b  reason: collision with root package name */
        private final TextView f3027b;

        /* renamed from: c  reason: collision with root package name */
        private Class<?> f3028c;

        /* renamed from: d  reason: collision with root package name */
        private Method f3029d;
        ...
        private void g(Menu menu) {
            ...
            Context context = this.f3027b.getContext();
            ...
            if (!this.f3031f) {
                ...
                try {
                    ...
                    this.f3028c = cls;
                    this.f3029d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.f3030e = true;
            ...
            try {
                if (this.f3030e && this.f3028c.isInstance(menu)) {
                    declaredMethod = this.f3029d;
                } else {
                ...
                for (int i10 = 0; i10 < c10.size(); i10++) {
                    ...
                    menu.add(0, 0, i10 + 100, resolveInfo.loadLabel(packageManager)).setIntent(b(resolveInfo, this.f3027b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f3026a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f3026a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f3026a.onDestroyActionMode(actionMode);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            g(menu);
            return this.f3026a.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static c.a f(TextView textView) {
        ...
        c.a.C0045a c0045a = new c.a.C0045a(new TextPaint(textView.getPaint()));
        if (i10 >= 23) {
            c0045a.b(c.a(textView));
            c0045a.c(c.d(textView));
        }
        if (i10 >= 18) {
            c0045a.d(e(textView));
        }
