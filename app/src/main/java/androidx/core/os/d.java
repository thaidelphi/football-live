...
public final class d {
    public static final Bundle a(i8.n<String, ? extends Object>... pairs) {
        kotlin.jvm.internal.n.f(pairs, "pairs");
        Bundle bundle = new Bundle(pairs.length);
        for (i8.n<String, ? extends Object> nVar : pairs) {
            String a10 = nVar.a();
            Object b10 = nVar.b();
            if (b10 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    kotlin.jvm.internal.n.d(b10, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(a10, (Parcelable[]) b10);
                } else if (String.class.isAssignableFrom(componentType)) {
                    kotlin.jvm.internal.n.d(b10, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(a10, (String[]) b10);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    kotlin.jvm.internal.n.d(b10, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
