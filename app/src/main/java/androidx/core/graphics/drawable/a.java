...
public final class a {
    ...
    private static Method f2631a;

    /* renamed from: b  reason: collision with root package name */
    private static boolean f2632b;

    /* renamed from: c  reason: collision with root package name */
    private static Method f2633c;
    ...
    public static void c(Drawable drawable) {
        ...
        if (i10 >= 23) {
            ...
            if (drawable instanceof InsetDrawable) {
                ...
                c(((androidx.core.graphics.drawable.c) drawable).a());
            } else if ((drawable instanceof DrawableContainer) && (drawableContainerState = (DrawableContainer.DrawableContainerState) ((DrawableContainer) drawable).getConstantState()) != null) {
                int childCount = drawableContainerState.getChildCount();
                for (int i11 = 0; i11 < childCount; i11++) {
                    Drawable b10 = C0039a.b(drawableContainerState, i11);
                    if (b10 != null) {
                        c(b10);
                    }
                }
    ...
    public static <T extends Drawable> T q(Drawable drawable) {
        return drawable instanceof androidx.core.graphics.drawable.c ? (T) ((androidx.core.graphics.drawable.c) drawable).a() : drawable;
    }
