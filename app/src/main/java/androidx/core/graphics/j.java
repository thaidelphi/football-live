...
public class j extends k {
    private Font l(FontFamily fontFamily, int i10) {
        FontStyle fontStyle = new FontStyle((i10 & 1) != 0 ? IronSourceError.ERROR_NT_LOAD_AFTER_INIT_FAILED : CommonGatewayClient.CODE_400, (i10 & 2) != 0 ? 1 : 0);
        Font font = fontFamily.getFont(0);
        int m7 = m(fontStyle, font.getStyle());
