...
class u {
    ...
    private static final int[] f1772c = {16843067, 16843068};

    /* renamed from: a  reason: collision with root package name */
    private final ProgressBar f1773a;
    ...
    private Drawable e(Drawable drawable) {
        if (drawable instanceof AnimationDrawable) {
            ...
            for (int i10 = 0; i10 < numberOfFrames; i10++) {
                ...
                d10.setLevel(UnityAdsConstants.AdOperations.SHOW_TIMEOUT_MS);
    ...
    public void c(AttributeSet attributeSet, int i10) {
        z0 v10 = z0.v(this.f1773a.getContext(), attributeSet, f1772c, i10, 0);
        Drawable h10 = v10.h(0);
        if (h10 != null) {
            this.f1773a.setIndeterminateDrawable(e(h10));
        }
        Drawable h11 = v10.h(1);
        if (h11 != null) {
            this.f1773a.setProgressDrawable(d(h11, false));
        }
        v10.w();
    }
